# 1 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
# 35 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ServiceCfg.h" 1
# 36 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c" 2
...
# 36 "0_Src/AppSw/Tricore/BSW_Module/Services/../Drivers/Mcal_Adc.h"
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/Services/../Drivers/Mcal_Adc.h" 2
...
# 59 "0_Src/BaseSw/iLLD/TC23A/Tricore/_Impl/IfxVadc_cfg.h"
...
# 60 "0_Src/BaseSw/iLLD/TC23A/Tricore/_Impl/IfxVadc_cfg.h" 2
...
# 54 "0_Src/BaseSw/iLLD/TC23A/Tricore/_PinMap/IfxVadc_PinMap.h" 2
...
# 78 "0_Src/BaseSw/iLLD/TC23A/Tricore/Vadc/Std/IfxVadc.h" 2
...
# 60 "0_Src/BaseSw/iLLD/TC23A/Tricore/_Impl/IfxMultican_cfg.h"
...
# 59 "0_Src/BaseSw/iLLD/TC23A/Tricore/_PinMap/IfxMultican_PinMap.h"
typedef const struct
{
    Ifx_CAN* module;
...
# 79 "0_Src/BaseSw/iLLD/TC23A/Tricore/Multican/Std/IfxMultican.h"
...
# 39 "0_Src/AppSw/Tricore/BSW_Module/Services/../Drivers/Mcal_Adc.h" 2
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c" 2
# 56 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
static single BSW_MaxValueDetect_20ms ( const single f32_AdcValue[ ( 20U ) ] );
...
# 72 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
...
static single f32s_realLdcTempLPF = 0.0F;
...
# 113 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
void Bsw_AdcInit ( void )
{
 sts_LdcIout.f32_AdcFailureValue = ( 0.0F );
 sts_LdcIout.u16_failureCnt = 0U;
 sts_LdcVout.f32_AdcFailureValue = ( 0.0F );
 sts_LdcVout.u16_failureCnt = 0U;
 sts_LdcIin.f32_AdcFailureValue = ( 0.0F );
 sts_LdcIin.u16_failureCnt = 0U;
 sts_LdcVin.f32_AdcFailureValue = ( 0.0F );
 sts_LdcVin.u16_failureCnt = 0U;
 sts_LdcTemp.f32_AdcFailureValue = ( 0.0F );
 sts_LdcTemp.u16_failureCnt = 0U;
 sts_LdcBatt.f32_AdcFailureValue = ( 0.0F );
 sts_LdcBatt.u16_failureCnt = 0U;

 sts_ObcIout.f32_AdcFailureValue = ( 0.0F );
 sts_ObcIout.u16_failureCnt = 0U;
 sts_ObcVout.f32_AdcFailureValue = ( 0.0F );
 sts_ObcVout.u16_failureCnt = 0U;
 sts_ObcIin.f32_AdcFailureValue = ( 0.0F );
 sts_ObcIin.u16_failureCnt = 0U;
 sts_ObcVin.f32_AdcFailureValue = ( 0.0F );
 sts_ObcVin.u16_failureCnt = 0U;
 sts_ObcTemp.f32_AdcFailureValue = ( 0.0F );
 sts_ObcTemp.u16_failureCnt = 0U;
}
# 147 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
void Bsw_Obc_AdcScan_20ms ( void )
{
 static byte u8s_hisPtr_20ms = 0u ;
 static single f32_ObcAdcAverIin_20ms;
 static single f32_hisObcIin_20ms[ ( 20U ) ];

 const st_LookupTable st_ObcIin_Table[ ( 19U ) ] =
 {
 ...
 if (u8s_hisPtr_20ms >= ( 20U ))
 {
  f32_ObcAdcAverIin_20ms = ( single )BSW_MaxValueDetect_20ms ( f32_hisObcIin_20ms );
 ...
 f32s_realObcIinLPF = BSW_GET_REALVALUE ( f32_ObcAdcAverIin_20ms, &sts_ObcIin, st_ObcIin_Table, ( 19U ) );
}
# 183 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Iout_adc_test = 0.0;
void Bsw_Ldc_Vadc0Scan ( void )
{
 const st_LookupTable st_LdcIout_Table[ ( 19U ) ] =
 {
 ...
 const st_LookupTable st_LdcVout_Table[ ( 19U ) ] =
 {
 ...
 const st_LookupTable st_LdcIin_Table[ ( 19U ) ] =
 {
 ...
 const st_LookupTable st_LdcVin_Table[ ( 19U ) ] =
 {
 ...
 const st_LookupTable st_LdcTemp_Table[ ( 19U ) ] =
 {
 ...
 const st_LookupTable st_Ldc14VBat_Table[ ( 19U ) ] =
 {
 ...
 f32s_realLdcIoutLPF = BSW_GET_REALVALUE ( f32_LdcAdcAverIout, &sts_LdcIout, st_LdcIout_Table, ( 19U ) );
 f32s_realLdcVoutLPF = BSW_GET_REALVALUE ( f32_LdcAdcAverVout, &sts_LdcVout, st_LdcVout_Table, ( 19U ) );
 f32s_realLdcIinLPF = BSW_GET_REALVALUE ( f32_LdcAdcAverIin, &sts_LdcIin, st_LdcIin_Table, ( 19U ) );
 f32s_realLdcVinLPF = BSW_GET_REALVALUE ( f32_LdcAdcAverVin, &sts_LdcVin, st_LdcVin_Table, ( 19U ) );
 f32s_realLdcTempLPF = BSW_GET_REALVALUE ( f32_LdcAdcAverTemp, &sts_LdcTemp, st_LdcTemp_Table, ( 19U ) );
 f32s_realLdc14BattLPF = BSW_GET_REALVALUE ( f32_LdcAdcAver14VBat, &sts_LdcBatt, st_Ldc14VBat_Table, ( 19U ) );

 f32s_realObc14BattLPF = ( f32_ObcAdcAver14VBat * ( 3.4f / 4095.0f ) ) * 5.3f;
}
# 270 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
void Bsw_Obc_Vadc1Scan ( void )
{
 const st_LookupTable st_ObcIout_Table[ ( 19U ) ] =
 {
 ...
 const st_LookupTable st_ObcVout_Table[ ( 19U ) ] =
 {
 ...
 const st_LookupTable st_ObcVin_Table[ ( 19U ) ] =
 {
 ...
 const st_LookupTable st_ObcTemp_Table[ ( 19U ) ] =
 {
  { 177.0F, 190.0F }, { 231.0F, 177.0F }, { 275.0F, 170.0F }, { 335.0F, 160.0F }, { 417.0F, 150.0F },
  { 507.0F, 140.0F }, { 632.0F, 130.0F }, { 772.0F, 120.0F }, { 943.0F, 110.0F }, { 1141.0F, 100.0F },
  { 1351.0F, 90.0F }, { 1568.0F, 80.0F }, { 1763.0F, 71.0F }, { 1945.0F, 61.0F }, { 2090.0F, 50.0F },
 ...
 f32s_realObcIoutLPF = BSW_GET_REALVALUE ( f32_ObcAdcAverIout, &sts_ObcIout, st_ObcIout_Table, ( 19U ) );
 f32s_realObcVoutLPF = BSW_GET_REALVALUE ( f32_ObcAdcAverVout, &sts_ObcVout, st_ObcVout_Table, ( 19U ) );
 f32s_realObcVinLPF = BSW_GET_REALVALUE ( f32_ObcAdcAverVin, &sts_ObcVin, st_ObcVin_Table, ( 19U ) );
 f32s_realObcTempLPF = BSW_GET_REALVALUE ( f32_ObcAdcAverTemp, &sts_ObcTemp, st_ObcTemp_Table, ( 19U ) );
}
# 329 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
void Bsw_Ldc_Vadc0Start ( void )
{
 IfxVadc_Adc_startScan ( &st_Vadc0Ldc.adcGroup );
}
# 341 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
void Bsw_Obc_Vadc1Start ( void )
{
 IfxVadc_Adc_startScan ( &st_Vadc1Obc.adcGroup );
}
# 353 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_LDC_InputCurr ( void )
{
 return f32s_realLdcIinLPF;
}
# 365 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_LDC_InputVolt ( void )
{
 return f32s_realLdcVinLPF;
}
# 377 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_LDC_DCOutputCurr ( void )
{
 return f32s_realLdcIoutLPF;
}
# 389 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_LDC_DCOutputVolt ( void )
{
 return f32s_realLdcVoutLPF;
}
# 401 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_LDC_BattVolt ( void )
{
 return f32s_realLdc14BattLPF;
}
# 414 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_LDC_Temperature ( void )
{
 return f32s_realLdcTempLPF;
}
# 426 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_OBC_ACInputCurr ( void )
{
 return f32s_realObcIinLPF;
}
# 438 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_OBC_ACInputVolt ( void )
{
 return f32s_realObcVinLPF;
}
# 450 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_OBC_DCOutputCurr ( void )
{
 return f32s_realObcIoutLPF;
}
# 462 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_OBC_DCOutputVolt ( void )
{
 return f32s_realObcVoutLPF;
}
# 474 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_OBC_AuxInVolt ( void )
{
 return f32s_realObc14BattLPF;
}
# 486 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
single Bsw_GET_OBC_Temperature ( void )
{
 return f32s_realObcTempLPF;
}
# 504 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
static single BSW_MaxValueDetect_20ms ( const single f32_AdcValue[ ( 20U ) ] )
{
 byte u8_idx = 0;
 single f32_max = f32_AdcValue[0];

 for( u8_idx = 0; u8_idx < ( 20U ); u8_idx++ )
 {
...
# 527 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
static single BSW_MovingAvg ( const word u16_ptrArrNumbers[] )
{
  byte u8_cnt = 0U;
  single f32_AvgRet;
  ...
  f32_AvgRet = ( single )( ( single )u16_Sum / ( ( 10U ) ) );


  return ( f32_AvgRet );
}
# 551 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
static single BSW_GET_REALVALUE ( single f32_AdcVal, st_AdcValuesType *stp_AdcValue, const st_LookupTable *stp_Table, byte u8_Size)
{
 ...
 {
  if( stp_AdcValue->u16_failureCnt > ( 500U ) )
  {
   stp_AdcValue->f32_realValue = ( -255.0F );
  }
  else
  {
...
# 580 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Adc.c"
static single LookupTableCalc ( single f32_AdcVal, const st_LookupTable *stp_Table, byte u8_Size )
{
 byte u8_Idx = 0U;
 single f32_PhysCalc;
