...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Timer/IfxCcu6_Timer.c"
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Timer/IfxCcu6_Timer.c"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Timer/IfxCcu6_Timer.h" 1
# 223 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
...
# 224 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Timer/IfxCcu6_Timer.h" 2
...
# 51 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Timer/IfxCcu6_Timer.c" 2
...
void IfxCcu6_Timer_initModule(IfxCcu6_Timer *timer, const IfxCcu6_Timer_Config *config)
{
    ...
    if ((config->timer == IfxCcu6_TimerId_t13) || (config->synchronousOperation))
    {
        ...
        if (IfxCcu6_getTimerAvailabilityStatus(ccu6SFR, IfxCcu6_TimerId_t13) == (0u))
        {
...
# 280 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Timer/IfxCcu6_Timer.c"
}
...
void IfxCcu6_Timer_start(IfxCcu6_Timer *timer)
{
    ...
    if (timer->timer == IfxCcu6_TimerId_t13)
    {
        ...
        if (!(timer->trigger.t13InSyncWithT12))
        {
            ...
            else
            {
                ...
                IfxCcu6_startTimer(timer->ccu6, (0u), (1u));
            }
        }
        else
        {}
    ...
    if ((timer->timer == IfxCcu6_TimerId_t12) || (timer->trigger.t13InSyncWithT12))
    {
        ...
        else
        {
            ...
            IfxCcu6_startTimer(timer->ccu6, (1u), (0u));
        }
    }
    else
    {}
...
void IfxCcu6_Timer_stop(IfxCcu6_Timer *timer)
{
    ...
    if ((timer->timer == IfxCcu6_TimerId_t13) || (timer->trigger.t13InSyncWithT12))
    {
        ...
        IfxCcu6_disableShadowTransfer(timer->ccu6, (0u), (1u));
        ...
        IfxCcu6_stopTimer(timer->ccu6, (0u), (1u));
    }
    ...
    else
    {
        ...
        IfxCcu6_disableShadowTransfer(timer->ccu6, (1u), (0u));
        ...
        IfxCcu6_stopTimer(timer->ccu6, (1u), (0u));
    }
}
...
void IfxCcu6_Timer_synchronousStart(IfxCcu6_Timer *timer)
{
    ...
    IfxCcu6_enableShadowTransfer(timer->ccu6, (1u), (1u));


    IfxCcu6_startTimer(timer->ccu6, (1u), (1u));
}
...
void IfxCcu6_Timer_synchronousStop(IfxCcu6_Timer *timer)
{
    ...
    IfxCcu6_disableShadowTransfer(timer->ccu6, (1u), (1u));


    IfxCcu6_stopTimer(timer->ccu6, (1u), (1u));
}
