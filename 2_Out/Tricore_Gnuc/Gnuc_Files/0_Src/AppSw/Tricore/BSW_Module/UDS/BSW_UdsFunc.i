# 1 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
# 35 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
...
# 36 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c" 2
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c" 2

# 1 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_DiagCfg.h" 1
# 39 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c" 2
...
# 40 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c" 2
...
# 41 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c" 2
# 1 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_Multican.h" 1
# 42 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c" 2
# 1 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_DFlash.h" 1
# 37 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_DFlash.h"
...
# 38 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_DFlash.h" 2
# 56 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_DFlash.h"
typedef struct
{
 dword sector;
 dword startPage;
...
# 78 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_DFlash.h"
...
# 43 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c" 2
# 68 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
...
byte u8g_UDS_ResetReq = ( 0U );
byte u8g_UDS_CommRx_CtrlSts = ( 0U );
byte u8g_UDS_CommTx_CtrlSts = ( 0U );
byte u8g_UDS_DTC_CtrlSts = ( 0U );
...
# 116 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
void Bsw_UdsFunc_Init ( void )
{
 u8s_DescNegResCode = ( 0x00U );
 u8s_DiagSessionSts = ( 0x01U );
 u8s_SecuritySts = ( 0U );
...
# 137 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
void Bsw_UdsFunc ( void )
{
 ...
 if( u8g_Can_DiagRxFlag == STATE_NORMAL )
 {
  ...
  if( Bsw_TpRecvProc ( &u8_IsEndFrame, &u8_RecvLen, &u8_RequestType ) != ( 0U ) )
  {
   u8s_DescNegResCode = ( 0x13U );
   st_MsgContext.u8_mContext = 0U;
   DescSendResponse ( &st_MsgContext );
  }
  else
  {
...
# 255 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void DescSendResponse ( const DescMsgContext *stp_MsgContext )
{
 byte u8_Sid;
 byte u8_ResDataLen;
...
# 295 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void DescSetNegResponse ( byte u8_mContext, byte u8_ErrorCode )
{
 if( u8_mContext != 0U ){}
...
# 310 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void ApplDescProcessDiagnosticSessionControl ( DescMsgContext *stp_MsgContext )
{
 byte u8_SubFunc;
 ...
 switch( u8_SubFunc )
 {
  case ( 0x01U ):
   if( stp_MsgContext->u16_mReqDataLen <= 0x02U )
   {
    ...
    u8s_SecuritySts = ( 0U );
    u8s_SecuritySequence = ( 0U );
    u8g_UDS_CommRx_CtrlSts = ( 0U );
    u8g_UDS_CommTx_CtrlSts = ( 0U );
  ...
  case ( 0x02U ):
   if( stp_MsgContext->u16_mReqDataLen <= 0x02U )
   {
    u8s_DiagSessionSts = ( 0x02U );

    u8s_SecuritySts = ( 0U );
    u8s_SecuritySequence = ( 0U );

    SetBootMode ( ( 0x0000B0B0U ) );
...
# 397 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void ApplDescProcessEcuReset ( DescMsgContext *stp_MsgContext )
{
 byte u8_SubFunc;
...
# 433 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void ApplDescProcessSecurityAccess ( DescMsgContext *stp_MsgContext )
{
 static byte u8s_Seed[ 4 ];
  byte u8_SubFunc;

 if( u8s_DiagSessionSts == ( 0x03U ) )
 {
  u8_SubFunc = stp_MsgContext->u8p_mReqData[ 0 ] & 0x7FU;
  ...
  switch( u8_SubFunc )
  {
   case ( 0x01U ):
    if( stp_MsgContext->u16_mReqDataLen <= 0x01U )
    {
     ...
     {
      if( u8s_SecuritySequence == ( 0U ) )
      {
       u8s_SecuritySequence = ( 1U );
       u8s_Seed[ 0 ] = 0U;
       u8s_Seed[ 1 ] = 0U;
       u8s_Seed[ 2 ] = 0U;
       u8s_Seed[ 3 ] = 0U;

       if( u8s_SecuritySts == ( 0U ) )
       {
        srand ( (*(Ifx_STM *)0xF0000000u).TIM0.U );
     ...
     {
      DescSetNegResponse ( stp_MsgContext->u8_mContext, ( 0x37U ) );
     }
    }
    else
    {
    ...
    if( stp_MsgContext->u16_mReqDataLen <= 0x05U )
    {
     if( u8s_SecuritySequence == ( 1U ) )
     {
      ...
      else
      {
       ...
       {
        u8s_SecurityTimeDlyCnt = 0U;
        u8s_SecurityTimeDlyReq = ( 1U );

        DescSetNegResponse ( stp_MsgContext->u8_mContext, ( 0x36U ) );
       }
       else
       {
...
# 553 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void ApplDescProcessCommunicatonControl ( DescMsgContext *stp_MsgContext )
{
 byte u8_SubFunc;
...
# 639 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void ApplDescProcessTesterPresent ( DescMsgContext *stp_MsgContext )
{
 byte u8_SubFunc;
...
# 673 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void ApplDescProcessControlDTCSetting ( DescMsgContext *stp_MsgContext )
{
 byte u8_SubFunc;
...
# 729 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void TesterTimeout_Check_Func ( void )
{
 if( u8s_DiagSessionSts != ( 0x01U ) )
 {
  u16s_TesterTimeout_cnt = U16_CountUp( u16s_TesterTimeout_cnt, ( 5000U / 1U ) );
  if( u16s_TesterTimeout_cnt == ( 5000U / 1U ) )
  {
   u8s_SecuritySts = ( 0U );
   u8s_SecuritySequence = ( 0U );
   u8g_UDS_CommRx_CtrlSts = ( 0U );
...
# 755 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_UdsFunc.c"
static void SetBootMode ( dword u32_BootMode )
{
 dword u32_ReadData;
 byte u8_WriteMode [4];

 u32_ReadData = *( ( volatile dword * )( 0xAF01E000U ) );

 if( ( ( u32_ReadData & 0x0000FFFFU ) != ( 0x0000E0E0U ) )
  && ( ( u32_ReadData & 0x0000FFFFU ) != u32_BootMode ) )
 {
  u8_WriteMode[ 0 ] = ( ( byte )( u32_BootMode ) );
  u8_WriteMode[ 1 ] = ( ( byte )( ( ( dword )( u32_BootMode ) ) >> 8 ) );
  u8_WriteMode[ 2 ] = ( ( byte )( ( ( dword )( u32_ReadData ) ) >> 16 ) );
  u8_WriteMode[ 3 ] = ( ( byte )( ( ( dword )( u32_ReadData ) ) >> 24 ) );

  ( void )Mcal_DFlashErase ( 15U );
  ( void )Mcal_DFlashWrite ( ( 0xAF01E000U ), 1U, u8_WriteMode );
 }
