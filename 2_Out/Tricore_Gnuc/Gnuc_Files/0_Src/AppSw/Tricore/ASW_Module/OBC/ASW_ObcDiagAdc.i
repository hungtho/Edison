# 1 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
# 35 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
...
# 36 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c" 2
# 1 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.h" 1
# 36 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.h"
# 1 "0_Src/AppSw/Tricore/RTE_Module/Rte_Typedef.h" 1
# 37 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.h" 2
...
# 37 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c" 2
...
# 38 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c" 2
# 56 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
...
# 72 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
...
# 89 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
void Asw_Obc_AdcInit( void )
{
 st_ObcVinLimit.f32_limit [ NOR_LOWER ] = ( 85.0f );
 st_ObcVinLimit.f32_limit [ NOR_UPPER ] = ( 265.0f );
 st_ObcVinLimit.f32_limit [ NOR_RECOVER_LOWER] = ( 90.0f );
 st_ObcVinLimit.f32_limit [ NOR_RECOVER_UPPER ] = ( 260.0f );

 st_ObcIinLimit.f32_limit [ NOR_LOWER ] = ( 0.0f );
 st_ObcIinLimit.f32_limit [ NOR_UPPER ] = ( 17.0f );
 st_ObcIinLimit.f32_limit [ NOR_RECOVER_LOWER ] = ( 0.0f );
 st_ObcIinLimit.f32_limit [ NOR_RECOVER_UPPER ] = ( 1.0f );

 st_ObcVoutLimit.f32_limit [ NOR_LOWER ] = ( 280.0f );
 st_ObcVoutLimit.f32_limit [ NOR_UPPER ] = ( 420.0f );
 st_ObcVoutLimit.f32_limit [ NOR_RECOVER_LOWER ] = ( 285.0f );
 st_ObcVoutLimit.f32_limit [ NOR_RECOVER_UPPER ] = ( 410.0f );

 st_ObcIoutLimit.f32_limit [ NOR_LOWER ] = ( 0.0f );
 st_ObcIoutLimit.f32_limit [ NOR_UPPER ] = ( 24.0f );
 st_ObcIoutLimit.f32_limit [ NOR_RECOVER_LOWER ] = ( 0.0f );
 st_ObcIoutLimit.f32_limit [ NOR_RECOVER_UPPER ] = ( 1.0f );
}
# 119 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
...
# 145 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
static en_STATE_DEF DiagAdc_ObcInputV ( en_STATE_DEF u8_HV_V, st_AdcLimitValue *stp_AdcLimit, single f32_adcRealInputV )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
# 167 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
 u8_rtn = STATE_NORMAL;

 return u8_rtn;
}
# 179 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
static en_STATE_DEF DiagAdc_ObcInputI ( en_STATE_DEF u8_HV_I, st_AdcLimitValue *stp_AdcLimit, single f32_adcRealInputI )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
# 197 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
 u8_rtn = STATE_NORMAL;


 return u8_rtn;
}
# 211 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
static en_STATE_DEF DiagAdc_ObcOutputV ( en_STATE_DEF u8_LV_V, st_AdcLimitValue *stp_AdcLimit, single f32_adcRealOutputV )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
# 233 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
 u8_rtn = STATE_NORMAL;

 return u8_rtn;
}
# 245 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcDiagAdc.c"
static en_STATE_DEF DiagAdc_ObcOutputI ( en_STATE_DEF u8_LV_I , st_AdcLimitValue *stp_AdcLimit, single f32_adcRealOutputI )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
