...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.c"
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.c"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h" 1
# 221 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
...
# 222 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/TPwm.h" 1
# 53 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/TPwm.h"
...
# 223 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h" 2
# 232 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
typedef struct
{
...
# 358 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_initModuleConfig(IfxCcu6_TPwm_Config *config, Ifx_CCU6 *ccu6);
# 377 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_initModule(IfxCcu6_TPwm *tPwm, const IfxCcu6_TPwm_Config *config);
# 386 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_pause(IfxCcu6_TPwm *tPwm);
# 395 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_resume(IfxCcu6_TPwm *tPwm);
# 404 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_start(IfxCcu6_TPwm *tPwm);
# 413 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_stop(IfxCcu6_TPwm *tPwm);
# 51 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.c" 2
...
# 342 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.c"
}
...
void IfxCcu6_TPwm_start(IfxCcu6_TPwm *tPwm)
{
    ...
    if (tPwm->timer == IfxCcu6_TimerId_t13)
    {
        ...
        IfxCcu6_enableShadowTransfer(tPwm->ccu6, (0u), (1u));
        ...
        if (!(tPwm->trigger.t13InSyncWithT12))
        {
            ...
            else
            {
                ...
                IfxCcu6_startTimer(tPwm->ccu6, (0u), (1u));
            }
        }
        else
        {}
    ...
    if ((tPwm->timer == IfxCcu6_TimerId_t12) || (tPwm->trigger.t13InSyncWithT12))
    {
        ...
        IfxCcu6_enableShadowTransfer(tPwm->ccu6, (1u), (0u));
        ...
        else
        {
            ...
            IfxCcu6_startTimer(tPwm->ccu6, (1u), (0u));
        }
    }
    else
    {}
...
void IfxCcu6_TPwm_stop(IfxCcu6_TPwm *tPwm)
{
    ...
    if ((tPwm->timer == IfxCcu6_TimerId_t13) || (tPwm->trigger.t13InSyncWithT12))
    {
        ...
        IfxCcu6_disableShadowTransfer(tPwm->ccu6, (0u), (1u));
        ...
        IfxCcu6_stopTimer(tPwm->ccu6, (0u), (1u));
    }
    ...
    else
    {
        ...
        IfxCcu6_disableShadowTransfer(tPwm->ccu6, (1u), (0u));
        ...
        IfxCcu6_stopTimer(tPwm->ccu6, (1u), (0u));
    }
