...
.Ltext0:
.section .text.Mcal_Obc_GtmTimInit,"ax",@progbits
	.align 1
	.global	Mcal_Obc_GtmTimInit
	.type	Mcal_Obc_GtmTimInit, @function
Mcal_Obc_GtmTimInit:
.LFB252:
	.file 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTim.c"
	.loc 1 84 0
.LVL0:
	sub.a	%SP, 56
.LCFI0:
...
.LVL2:
	.loc 1 164 0
	movh	%d2, hi:IfxGtm_TIM0_3_TIN21_P00_12_IN
	.loc 1 167 0
	movh.a	%a4, hi:st_timDriver
	.loc 1 163 0
	mov	%d15, 0
	.loc 1 164 0
	addi	%d2, %d2, lo:IfxGtm_TIM0_3_TIN21_P00_12_IN
	.loc 1 167 0
	lea	%a4, [%a4] lo:st_timDriver
	lea	%a5, [%SP] 4
	.loc 1 163 0
	st.b	[%SP] 18, %d15
	.loc 1 164 0
...
.LBE8:
.LFE252:
	.size	Mcal_Obc_GtmTimInit, .-Mcal_Obc_GtmTimInit
.section .text.Mcal_Obc_GtmTimFreMeasure,"ax",@progbits
	.align 1
	.global	Mcal_Obc_GtmTimFreMeasure
	.type	Mcal_Obc_GtmTimFreMeasure, @function
Mcal_Obc_GtmTimFreMeasure:
.LFB253:
	.loc 1 97 0
	.loc 1 102 0
	movh.a	%a15, hi:st_timDriver
	ld.a	%a15, [%a15] lo:st_timDriver
.LVL4:
.LBB10:
.LBB11:
...
.LBE10:
	...
	.loc 1 116 0
	mov	%d15, 0
	movh.a	%a15, hi:f32s_GtmTimFre
.LVL5:
	st.w	[%a15] lo:f32s_GtmTimFre, %d15
	ret
.LVL6:
.L6:
.LBB12:
...
.LBE12:
	.loc 1 107 0
	ld.w	%d15, [%a15] 4
	movh.a	%a2, hi:GPR1.10698
	st.w	[%a2] lo:GPR1.10698, %d15
	.loc 1 108 0
	ld.w	%d15, [%a15]0
	movh.a	%a15, hi:GPR0.10697
.LVL7:
	st.w	[%a15] lo:GPR0.10697, %d15
	.loc 1 109 0
	ld.w	%d15, [%a2] lo:GPR1.10698
	.loc 1 111 0
	ld.w	%d2, [%a15] lo:GPR0.10697
	.loc 1 109 0
	insert	%d15, %d15, 0, 24, 8
	.loc 1 111 0
	insert	%d2, %d2, 0, 24, 8
	movh.a	%a15, hi:u32s_GtmTimDuty
	.loc 1 109 0
	movh.a	%a2, hi:period_ticks.10699
	.loc 1 111 0
	st.w	[%a15] lo:u32s_GtmTimDuty, %d2
	.loc 1 109 0
	st.w	[%a2] lo:period_ticks.10699, %d15
	.loc 1 112 0
	movh	%d2, 19647
	utof	%d15, %d15
	addi	%d2, %d2, -17376
	...
	ret
.LFE253:
	.size	Mcal_Obc_GtmTimFreMeasure, .-Mcal_Obc_GtmTimFreMeasure
.section .text.Mcal_Obc_GtmTimDutyJ1772,"ax",@progbits
	.align 1
	.global	Mcal_Obc_GtmTimDutyJ1772
	.type	Mcal_Obc_GtmTimDutyJ1772, @function
Mcal_Obc_GtmTimDutyJ1772:
.LFB254:
	.loc 1 128 0
	.loc 1 130 0
	movh.a	%a15, hi:u32s_GtmTimDuty
	ld.w	%d2, [%a15] lo:u32s_GtmTimDuty
	ret
.LFE254:
	.size	Mcal_Obc_GtmTimDutyJ1772, .-Mcal_Obc_GtmTimDutyJ1772
.section .text.Mcal_Obc_GtmTimFreqJ1772,"ax",@progbits
	.align 1
	.global	Mcal_Obc_GtmTimFreqJ1772
	.type	Mcal_Obc_GtmTimFreqJ1772, @function
Mcal_Obc_GtmTimFreqJ1772:
.LFB255:
	.loc 1 140 0
	.loc 1 142 0
	movh.a	%a15, hi:f32s_GtmTimFre
	ld.w	%d2, [%a15] lo:f32s_GtmTimFre
	ret
.LFE255:
	.size	Mcal_Obc_GtmTimFreqJ1772, .-Mcal_Obc_GtmTimFreqJ1772
.section .bss.period_ticks.10699,"aw",@nobits
	.align 2
	.type	period_ticks.10699, @object
	.size	period_ticks.10699, 4
period_ticks.10699:
	.zero	4
.section .bss.GPR0.10697,"aw",@nobits
	.align 2
	.type	GPR0.10697, @object
	.size	GPR0.10697, 4
GPR0.10697:
	.zero	4
.section .bss.GPR1.10698,"aw",@nobits
	.align 2
	.type	GPR1.10698, @object
	.size	GPR1.10698, 4
GPR1.10698:
	.zero	4
.section .bss.u32s_GtmTimDuty,"aw",@nobits
	.align 2
	.type	u32s_GtmTimDuty, @object
	.size	u32s_GtmTimDuty, 4
u32s_GtmTimDuty:
	.zero	4
.section .bss.f32s_GtmTimFre,"aw",@nobits
	.align 2
	.type	f32s_GtmTimFre, @object
	.size	f32s_GtmTimFre, 4
f32s_GtmTimFre:
	.zero	4
.section .bss.st_timDriver,"aw",@nobits
	.align 2
	.type	st_timDriver, @object
	.size	st_timDriver, 32
st_timDriver:
	.zero	32
...
.Letext0:
	...
	.file 14 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h"
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTim.c"
	...
	.uleb128 0x26
	.byte	0x1
	.string	"Mcal_Obc_GtmTimFreMeasure"
	.byte	0x1
	.byte	0x60
	.byte	0x1
	.uaword	.LFB253
	...
	.uleb128 0x32
	.byte	0x1
	.string	"Mcal_Obc_GtmTimDutyJ1772"
	.byte	0x1
	.byte	0x7f
	.byte	0x1
	.uaword	0xb074
	...
	.uleb128 0x32
	.byte	0x1
	.string	"Mcal_Obc_GtmTimFreqJ1772"
	.byte	0x1
	.byte	0x8b
	.byte	0x1
	.uaword	0xb081
	...
	.uaword	st_timDriver
	.uleb128 0x2f
	.string	"f32s_GtmTimFre"
	.byte	0x1
	.byte	0x44
	.uaword	0xb081
	.byte	0x5
	.byte	0x3
	.uaword	f32s_GtmTimFre
	.uleb128 0x2f
	.string	"u32s_GtmTimDuty"
	.byte	0x1
	.byte	0x45
	.uaword	0xb074
	.byte	0x5
	.byte	0x3
	.uaword	u32s_GtmTimDuty
	.uleb128 0x33
