# 1 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
# 35 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
...
# 36 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c" 2
...
# 37 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c" 2
...
# 38 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c" 2
...
# 39 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c" 2
...
# 40 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c" 2
...
# 42 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c" 2
# 59 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
...
static byte u8s_OBC_ChargingReady = 0U;
static byte u8s_Bms_SystemChargingReady = 0U;
static byte u8g_Bms_Hw_OBCEnable = 0U;
...
# 115 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
...
# 147 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
...
# 189 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_SET_ACRly_PFC_PWM_ON ( void )
{
 byte u8_ret = 0U;

 if( u8s_ACChargingReady100msOnCnt <= ( 20U ) )
 {
  u8s_AcRlySta = ( byte )EN_OBC_On;
  Bsw_Set_GpioWrite( RELAY_OUT, ( byte )EN_OBC_On );
  u8s_ACChargingReady100msOnCnt++;
 }
 else if( ( ( 20U ) < u8s_ACChargingReady100msOnCnt )
    && ( u8s_ACChargingReady100msOnCnt <= ( 40U ) ) )
 {
  u8s_PFCSta = ( byte )EN_OBC_On;
  Bsw_Set_GpioWrite( PFC_ENABLE_OUT, ( byte )EN_OBC_On );
  u8s_ACChargingReady100msOnCnt++;
 }
 else if( ( ( 40U ) < u8s_ACChargingReady100msOnCnt )
    && ( u8s_ACChargingReady100msOnCnt <= ( 60U ) ) )
 {
...
# 228 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_SET_ACRly_PFC_PWM_OFF ( void )
{
 byte u8_ret = 0U;

 if( u8s_ACChargingReady100msOffCnt <= ( 20U ) )
 {
  u8s_PWMSta = ( byte )EN_OBC_Off;
  u8g_ObcPWMEnable = ( byte )EN_OBC_Off;
  u8s_ACChargingReady100msOffCnt++;
 }
 else if( ( ( 20U ) < u8s_ACChargingReady100msOffCnt )
    && ( u8s_ACChargingReady100msOffCnt <= ( 40U ) ) )
 {
  u8s_PFCSta = ( byte )EN_OBC_Off;
  Bsw_Set_GpioWrite( PFC_ENABLE_OUT, ( byte )EN_OBC_Off );
  u8s_ACChargingReady100msOffCnt++;
 }
 else if( ( ( 40U ) < u8s_ACChargingReady100msOffCnt )
    && ( u8s_ACChargingReady100msOffCnt <= ( 60U ) ) )
 {
...
# 267 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_GET_OBC_ReadySta ( void )
{
 return u8g_OBC_ReadySta;
}
# 279 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_GET_OBC_ACDetectSta ( void )
{
 return u8g_OBC_ACDetectSta;
}
# 291 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_GET_OBC_ChargeFinishReq ( void )
{
 return u8g_OBC_ChargeFinishReq;
}
# 303 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_GET_OBC_ControllableSta ( void )
{
 return u8g_OBC_ControllableSta;
}
# 315 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_GET_OBC_HVILSta ( void )
{
 return u8g_OBC_HVILSta;
}
# 327 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_GET_OBC_OperatingMode ( void )
{
 return u8g_OBC_OperatingMode;
}
# 339 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_GET_OBC_PowerDeratingSta ( void )
{
 return u8g_OBC_PowerDeratingSta;
}
# 351 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
byte Asw_GET_ObcPWMEnable ( void )
{
 return u8g_ObcPWMEnable;
}
# 368 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
static byte ChkBms_SysChargingReady ( void )
{
 ...
 if( ( u8s_OBC_ChargingReady == ( byte )EN_OBC_On )
  ...
  && ( st_rteObcIn.st_CANValue.u8_Bms_ChargeMode == 1U ) )
 {
  u8_rslt = EN_OBC_On;
 }
...
# 391 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
static byte ChkOBC_ChargingReady ( void )
{
 byte u8_rslt = EN_OBC_Off;
...
# 436 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
static byte ChkOBC_ACDetectSta ( single f32_ACVIn )
{
 byte u8_rslt = EN_OBC_Off;
...
# 455 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
static byte ChkOBC_ControllableSta ( single f32_ACVIn )
{
 byte u8_rslt = EN_OBC_Off;
...
# 475 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
static byte ChkOBC_HVILSta ( void )
{
...
# 500 "0_Src/AppSw/Tricore/ASW_Module/OBC/ASW_ObcChargeSeq.c"
static byte ChkAdcChangeModeFault ( const st_DiagnosisType* stp_DetectedFlag )
{
 byte rtnVal = 0U;
