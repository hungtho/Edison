...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Std/IfxCcu6.c"
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Std/IfxCcu6.c"
...
# 51 "0_Src/BaseSw/iLLD/TC23A/Tricore/Ccu6/Std/IfxCcu6.c" 2
...
void IfxCcu6_disableModule(Ifx_CCU6 *ccu6)
{
    ...
    while (IfxCcu6_isModuleEnabled(ccu6) == (1u))
    {}
}
...
void IfxCcu6_enableModule(Ifx_CCU6 *ccu6)
{
    ...
    while (IfxCcu6_isModuleEnabled(ccu6) == (0u))
    {}
}
...
float32 IfxCcu6_setT12Frequency(Ifx_CCU6 *ccu6, float32 frequency, Ifx_TimerValue period, IfxCcu6_T12CountMode countMode)
{
    ...
    if (prescaler < 16)
    {
        ...
        IfxCcu6_enableShadowTransfer(ccu6, (1u), (0u));
...
float32 IfxCcu6_setT13Frequency(Ifx_CCU6 *ccu6, float32 frequency, Ifx_TimerValue period)
{
    ...
    if (prescaler < 16)
    {
        ...
        IfxCcu6_enableShadowTransfer(ccu6, (0u), (1u));
