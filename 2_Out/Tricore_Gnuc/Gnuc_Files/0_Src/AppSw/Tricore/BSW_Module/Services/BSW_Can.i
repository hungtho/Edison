# 1 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
# 35 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
...
# 36 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c" 2
# 1 "0_Src/AppSw/Tricore/RTE_Module/Rte_ApiOut.h" 1
# 36 "0_Src/AppSw/Tricore/RTE_Module/Rte_ApiOut.h"
# 1 "0_Src/AppSw/Tricore/RTE_Module/Rte_Typedef.h" 1
# 37 "0_Src/AppSw/Tricore/RTE_Module/Rte_ApiOut.h" 2
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c" 2
# 1 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ServiceCfg.h" 1
# 38 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c" 2
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/Services/../Drivers/Mcal_Multican.h"
...
# 39 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c" 2
...
# 41 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c" 2
# 59 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
...
# 129 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
void Bsw_CRC8_Init ( void )
{
 Bsw_Crc8TableGenerator ( ( 0x1DU ), u8s_CrcTable8bit );
}
# 141 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
void Bsw_CANRxLDCData_100ms ( void )
{
 u8s_VcuCmdEnLdc = ( byte )( ( ( byte )( stg_Rxmsg_VCU1_LDC.data[ 0 ] ) ) ) >> 6U;
 f32s_VcuCmdLdcTargetVolt = ( single )( ( ( byte )( ( ( dword )( stg_Rxmsg_VCU1_LDC.data[ 0 ] ) ) >> 16 ) ) );



}
# 158 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
...
# 174 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
...
# 189 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
...
# 205 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_BMS_OBC_CmdEnable ( void )
{
 return u8s_BmsObcCmdEnOBC;
}
# 217 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_BMS_OBC_CmdRelay ( void )
{
 return u8s_BmsObcCmdRelay;
}
# 229 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_BMS_OBC_CmdPfc_Enable ( void )
{
 return u8s_BmsObcCmdPFC_Enable;
}
# 241 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_Bms_ACChargingReady ( void )
{
 return u8s_Bms_ACChargingReady;
}
# 253 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_Bms_HWTestMode ( void )
{
 return u8s_Bms_HWTestMode;
}
# 266 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_Bms_ACPP ( void )
{
 return u8s_Bms_ACPP;
}
# 278 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_Bms_ACCP ( void )
{
 return u8s_Bms_ACCP;
}
# 290 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_Bms_ChargeEnd ( void )
{
 return u8s_Bms_ChargeEnd;
}
# 302 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_Bms_ChargeMode ( void )
{
 return u8s_Bms_ChargeMode;
}
# 314 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_Bms_EnableOBCWakeup ( void )
{
 return u8s_Bms_EnableOBCPWM;
}
# 326 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_Bms_ACPwmDuty ( void )
{
 return u8s_Bms_ACPwmDuty;
}
# 338 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_Bms_ACChargeCapacity ( void )
{
 return u8s_Bms_ACChargeCapacity;
}
# 350 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
single Bsw_GET_Bms_ObcCmdVoltage ( void )
{
 return ( single )u16s_Bms_ObcCmdVoltage/10.0F;
}
# 363 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
single Bsw_GET_Bms_ObcCmdCurr ( void )
{
 return ( single )u16s_Bms_ObcCmdCurr/100.0F;
}
# 375 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
byte Bsw_GET_VcuCmdEnLdc ( void )
{
 return u8s_VcuCmdEnLdc;
}
# 387 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
single Bsw_GET_VcuCmdLdcTargetVolt ( void )
{
 return f32s_VcuCmdLdcTargetVolt/10.0F;
}
# 399 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
en_STATE_DEF Bsw_GET_CanBusOff ( void )
{
 return u8g_CAN_BusoffSts;
}
# 411 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
en_STATE_DEF Bsw_GET_Ldc_CanTimeout ( void )
{
 return u8g_Ldc_CanTimeout;
}
# 423 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
en_STATE_DEF Bsw_GET_Obc_CanTimeout ( void )
{
 return u8g_Obc_CanTimeout;
}
# 440 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static byte Bsw_CRC8_Calc ( byte *u8p_Data, byte u8_Size )
{
 byte u8_CalcRet;


 u8_CalcRet = Bsw_CalculateCRC8 ( u8s_CrcTable8bit, u8p_Data, u8_Size, ( 0xFFU ), ( 0xFFU ) );

 return ( u8_CalcRet );
}
# 457 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static void Bsw_Crc8TableGenerator ( byte u8_Polynomial, byte u8_CrcTable[ 256 ] )
{
 byte u8_Remainder;
...
# 493 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static byte Bsw_CalculateCRC8 ( byte u8_CrcTable[ 256 ], const byte *u8p_Crc_DataPtr, byte u8_Crc_Len, byte u8_Crc_InitialValue, byte u8_Crc_XorValue )
{
 byte u8_Temp;
...
# 520 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static void Bsw_CANRxData100ms_BMS1_OBC ( void )
{



 u16s_Bms_ObcCmdCurr = ( ( word )( ( ( ( word )( ( ( byte )( ( ( dword )( stg_Rxmsg_BMS1_OBC.data[ 0 ] ) ) >> 8 ) ) ) & 0x00FFU ) << 8 ) | ( ( word )( ( ( byte )( stg_Rxmsg_BMS1_OBC.data[ 0 ] ) ) ) ) ) );
 u16s_Bms_ObcCmdVoltage = ( ( word )( ( ( ( word )( ( ( byte )( ( ( dword )( stg_Rxmsg_BMS1_OBC.data[ 0 ] ) ) >> 24 ) ) ) & 0x00FFU ) << 8 ) | ( ( word )( ( ( byte )( ( ( dword )( stg_Rxmsg_BMS1_OBC.data[ 0 ] ) ) >> 16 ) ) ) ) ) );

 u8s_Bms_ACChargingReady = ( byte )( ( ( byte )( stg_Rxmsg_BMS1_OBC.data[ 1 ] ) ) & ( 0x3U ) );
 u8s_BmsObcCmdEnOBC = ( byte )( ( ( ( byte )( stg_Rxmsg_BMS1_OBC.data[ 1 ] ) ) ) >> 2U );

 u8s_Bms_HWTestMode = ( byte )( ( ( byte )( ( ( dword )( stg_Rxmsg_BMS1_OBC.data[ 1 ] ) ) >> 8 ) ) & ( 0x1U ) );
 u8s_BmsObcCmdRelay = ( byte )( ( ( ( byte )( ( ( dword )( stg_Rxmsg_BMS1_OBC.data[ 1 ] ) ) >> 8 ) ) & ( 0x2U ) ) >> 1U );
 u8s_BmsObcCmdPFC_Enable = ( byte )( ( ( ( byte )( ( ( dword )( stg_Rxmsg_BMS1_OBC.data[ 1 ] ) ) >> 8 ) ) & ( 0x4U ) ) >> 2U );
 u8s_Bms_EnableOBCPWM = ( byte )( ( ( ( byte )( ( ( dword )( stg_Rxmsg_BMS1_OBC.data[ 1 ] ) ) >> 8 ) ) & ( 0x8U ) ) >> 3U );



}
# 547 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static void Bsw_CANRxData100ms_BMS2_OBC ( void )
{
 u8s_Bms_ACPP = ( byte )( ( byte )( ( ( dword )( stg_Rxmsg_BMS2_OBC.data[ 0 ] ) ) >> 16 ) );
 u8s_Bms_ACCP = ( byte )( ( byte )( ( ( dword )( stg_Rxmsg_BMS2_OBC.data[ 0 ] ) ) >> 24 ) );

 u8s_Bms_ACPwmDuty = ( byte )( ( byte )( stg_Rxmsg_BMS2_OBC.data[ 1 ] ) );
 u8s_Bms_ACChargeCapacity = ( byte )( ( byte )( ( ( dword )( stg_Rxmsg_BMS2_OBC.data[ 1 ] ) ) >> 8 ) );
}
# 563 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static void Bsw_CANRxData100ms_BMS2 ( void )
{
 u8s_Bms_ChargeEnd = ( byte )( ( ( byte )( ( ( dword )( stg_Rxmsg_BMS2.data[ 1 ] ) ) >> 8 ) ) >> 4U );
}
# 575 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static void Bsw_CANRxData100ms_BMS10 ( void )
{
 u8s_Bms_ChargeMode = ( byte )( ( byte )( ( ( dword )( stg_Rxmsg_BMS10.data[ 1 ] ) ) >> 24 ) ) & ( 0x3U );
}
...
static void Bsw_CANTxOBCData_100ms_OBC_1 ( void )
{
 ...
 single f32_realObcTemp = ( Bsw_GET_OBC_Temperature() * ( 10.0F ) );
 ...
 st_TxOBC_1.B2 = ( ( byte )( u16_realObcTemp ) );
 st_TxOBC_1.B3 = ( ( byte )( ( ( u16_realObcTemp ) & 0xFF00U ) >> 8 ) );
 st_TxOBC_1.B4 = 0U;
 st_TxOBC_1.B5 = 0U;
 st_TxOBC_1.B6 = 0U;
 st_TxOBC_1.B7 = ( byte )( u8g_OBC_CRC );

 st_CAN_Tx_OBC_1.data[ 0 ] = ( ( dword )( ( ( ( dword )( st_TxOBC_1.B3 ) ) << 24 ) | ( ( ( dword )( st_TxOBC_1.B2 ) ) << 16 ) | ( ( ( dword )( st_TxOBC_1.B1 ) ) << 8 ) | ( ( dword )( st_TxOBC_1.B0 ) ) ) );
 st_CAN_Tx_OBC_1.data[ 1 ] = ( ( dword )( ( ( ( dword )( st_TxOBC_1.B7 ) ) << 24 ) | ( ( ( dword )( st_TxOBC_1.B6 ) ) << 16 ) | ( ( ( dword )( st_TxOBC_1.B5 ) ) << 8 ) | ( ( dword )( st_TxOBC_1.B4 ) ) ) );

 u8_Checksum_OBC1_Data[ 0 ] = ( ( byte )( st_CAN_Tx_OBC_1.data[ 0 ] ) );
 u8_Checksum_OBC1_Data[ 1 ] = ( ( byte )( ( ( dword )( st_CAN_Tx_OBC_1.data[ 0 ] ) ) >> 8 ) );
 u8_Checksum_OBC1_Data[ 2 ] = ( ( byte )( ( ( dword )( st_CAN_Tx_OBC_1.data[ 0 ] ) ) >> 16 ) );
 u8_Checksum_OBC1_Data[ 3 ] = ( ( byte )( ( ( dword )( st_CAN_Tx_OBC_1.data[ 0 ] ) ) >> 24 ) );
 u8_Checksum_OBC1_Data[ 4 ] = ( ( byte )( ( ( dword )( st_CAN_Tx_OBC_1.data[ 1 ] ) ) >> 24 ) );

 u8g_OBC_CRC = Bsw_CRC8_Calc ( u8_Checksum_OBC1_Data, 5U );


 Mcal_CanTransmit( ( 0x18FF3071U ), &st_CAN_Tx_OBC_1, &stg_MulticanBasic.can0TxMsgObj_OBC_1 );
}
# 634 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static void Bsw_CANTxOBCData_100ms_OBC_2( void )
{
 IfxMultican_Message st_CAN_Tx_OBC_2;
 st_CANType st_TxOBC_2 = { 0, };

 single f32_realObcAcInCur = ( Bsw_GET_OBC_ACInputCurr() * ( 100.0F ) );
 word u16_realObcAcInCur = ( word )f32_realObcAcInCur;

 single f32_realObcAcInVol = ( Bsw_GET_OBC_ACInputVolt() * ( 10.0F ) );
 word u16_realObcAcInVol = ( word )f32_realObcAcInVol;

 single f32_realObcOutCur = ( Bsw_GET_OBC_DCOutputCurr() * ( 100.0F ) );
 word u16_realObcOutCur = ( word )f32_realObcOutCur;

 single f32_realObcOutVol = ( Bsw_GET_OBC_DCOutputVolt() * ( 10.0F ) );
 word u16_realObcOutVol = ( word )f32_realObcOutVol;


 st_TxOBC_2.B0 = ( ( byte )( u16_realObcAcInCur ) );
 st_TxOBC_2.B1 = ( ( byte )( ( ( u16_realObcAcInCur ) & 0xFF00U ) >> 8 ) );
 st_TxOBC_2.B2 = ( ( byte )( u16_realObcAcInVol ) );
 st_TxOBC_2.B3 = ( ( byte )( ( ( u16_realObcAcInVol ) & 0xFF00U ) >> 8 ) );

 st_TxOBC_2.B4 = ( ( byte )( u16_realObcOutCur ) );
 st_TxOBC_2.B5 = ( ( byte )( ( ( u16_realObcOutCur ) & 0xFF00U ) >> 8 ) );
 st_TxOBC_2.B6 = ( ( byte )( u16_realObcOutVol ) );
 st_TxOBC_2.B7 = ( ( byte )( ( ( u16_realObcOutVol ) & 0xFF00U ) >> 8 ) );

 st_CAN_Tx_OBC_2.data[ 0 ] = ( ( dword )( ( ( ( dword )( st_TxOBC_2.B3 ) ) << 24 ) | ( ( ( dword )( st_TxOBC_2.B2 ) ) << 16 ) | ( ( ( dword )( st_TxOBC_2.B1 ) ) << 8 ) | ( ( dword )( st_TxOBC_2.B0 ) ) ) );
 st_CAN_Tx_OBC_2.data[ 1 ] = ( ( dword )( ( ( ( dword )( st_TxOBC_2.B7 ) ) << 24 ) | ( ( ( dword )( st_TxOBC_2.B6 ) ) << 16 ) | ( ( ( dword )( st_TxOBC_2.B5 ) ) << 8 ) | ( ( dword )( st_TxOBC_2.B4 ) ) ) );


 Mcal_CanTransmit( ( 0x18FF3171U ), &st_CAN_Tx_OBC_2, &stg_MulticanBasic.can0TxMsgObj_OBC_2 );
}
# 676 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static void Bsw_CANTxLDCData_100ms_LDC_1( void )
{
 ...
 {
 case LDC_MODE_READY :
  u8s_LdcProtecStatus = ( 0x1U );
  u8s_LdcReadyStatus = ( 0x0U );
  break;

 case LDC_MODE_NORMAL :
  u8s_LdcProtecStatus = ( 0x3U );
  u8s_LdcReadyStatus = ( 0x1U );
  u8s_LdcOutputControlMode = ( 0x0U );
  break;

 case LDC_MODE_FAILURE :
  u8s_LdcProtecStatus = ( 0x4U );
  u8s_LdcReadyStatus = ( 0x0U );
  break;
 ...
 default :
  u8s_LdcProtecStatus = ( 0x0U );
  u8s_LdcReadyStatus = ( 0x0U );
  break;
 }

 if( ( Bsw_GET_LDC_DCOutputCurr() > ( -255.0F ) )
  && ( Bsw_GET_LDC_DCOutputVolt() > ( -255.0F ) ) )
 {
  st_TxLDC_1.B0 = ( byte )( u8_realLdcPowerLPF );
 }

 if( Bsw_GET_LDC_Temperature() > ( -255.0F ) )
 {
  st_TxLDC_1.B1 = ( ( byte )( u16_realLdcTempLPF_x10 ) );
  st_TxLDC_1.B2 = ( ( byte )( ( ( u16_realLdcTempLPF_x10 ) & 0xFF00U ) >> 8 ) );
 }
 ...
 st_CAN_Tx_LDC_1.data[ 0 ] = ( ( dword )( ( ( ( dword )( st_TxLDC_1.B3 ) ) << 24 ) | ( ( ( dword )( st_TxLDC_1.B2 ) ) << 16 ) | ( ( ( dword )( st_TxLDC_1.B1 ) ) << 8 ) | ( ( dword )( st_TxLDC_1.B0 ) ) ) );
 st_CAN_Tx_LDC_1.data[ 1 ] = ( ( dword )( ( ( ( dword )( st_TxLDC_1.B7 ) ) << 24 ) | ( ( ( dword )( st_TxLDC_1.B6 ) ) << 16 ) | ( ( ( dword )( st_TxLDC_1.B5 ) ) << 8 ) | ( ( dword )( st_TxLDC_1.B4 ) ) ) );


 Mcal_CanTransmit ( ( 0x18FF3070U ), &st_CAN_Tx_LDC_1, &stg_MulticanBasic.can0TxMsgObj_LDC_1 );
}
# 764 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_Can.c"
static void Bsw_CANTxLDCData_100ms_LDC_2( void )
{
 ...
 if( Bsw_GET_LDC_InputVolt() > ( -255.0F ) )
 {
  st_TxLDC_2.B0 = ( ( byte )( u16_realLdcVinLPF_x10 ) );
  st_TxLDC_2.B1 = ( ( byte )( ( ( u16_realLdcVinLPF_x10 ) & 0xFF00U ) >> 8 ) );



 }

 if( Bsw_GET_LDC_DCOutputVolt() > ( -255.0F ) )
 {
  st_TxLDC_2.B2 = ( byte )( u16_realLdcVoutLPF_x10 ) & ( 0xFFU );
 }

 if( Bsw_GET_LDC_InputCurr() > ( -255.0F ) )
 {
 ...
 if( Bsw_GET_LDC_DCOutputCurr() > ( -255.0F ) )
 {
  st_TxLDC_2.B4 = ( ( byte )( u16_realLdcIoutLPF_x10 ) );
  st_TxLDC_2.B5 = ( ( byte )( ( ( u16_realLdcIoutLPF_x10 ) & 0xFF00U ) >> 8 ) );
 }

 st_CAN_Tx_LDC_2.data[ 0 ] = ( ( dword )( ( ( ( dword )( st_TxLDC_2.B3 ) ) << 24 ) | ( ( ( dword )( st_TxLDC_2.B2 ) ) << 16 ) | ( ( ( dword )( st_TxLDC_2.B1 ) ) << 8 ) | ( ( dword )( st_TxLDC_2.B0 ) ) ) );
 st_CAN_Tx_LDC_2.data[ 1 ] = ( ( dword )( ( ( ( dword )( st_TxLDC_2.B7 ) ) << 24 ) | ( ( ( dword )( st_TxLDC_2.B6 ) ) << 16 ) | ( ( ( dword )( st_TxLDC_2.B5 ) ) << 8 ) | ( ( dword )( st_TxLDC_2.B4 ) ) ) );


 Mcal_CanTransmit ( ( 0x18FF3170U ), &st_CAN_Tx_LDC_2, &stg_MulticanBasic.can0TxMsgObj_LDC_2 );
}
