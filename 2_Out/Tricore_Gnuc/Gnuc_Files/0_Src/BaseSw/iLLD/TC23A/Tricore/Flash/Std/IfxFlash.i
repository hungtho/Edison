...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Flash/Std/IfxFlash.c"
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Flash/Std/IfxFlash.c"
...
# 62 "0_Src/BaseSw/iLLD/TC23A/Tricore/Flash/Std/IfxFlash.h" 2
...
# 63 "0_Src/BaseSw/iLLD/TC23A/Tricore/Flash/Std/IfxFlash.h" 2
...
# 51 "0_Src/BaseSw/iLLD/TC23A/Tricore/Flash/Std/IfxFlash.c" 2
...
uint32 IfxFlash_getTrackedCorrectableErrors(IfxFlash_PortId portId, IfxFlash_ErrorTracking_Address *trackedFlashAdresses)
{
         ...
         ++i)
    {
        ...
        (*(Ifx_FLASH *)0xF8001000u).CBAB[portId].TOP.U = (((uint32)1) << 31);
    }
...
uint32 IfxFlash_getTrackedUncorrectableErrors(IfxFlash_PortId portId, IfxFlash_ErrorTracking_Address *trackedFlashAdresses)
{
         ...
         ++i)
    {
        ...
        (*(Ifx_FLASH *)0xF8001000u).UBAB[portId].TOP.U = (((uint32)1) << 31);
    }
