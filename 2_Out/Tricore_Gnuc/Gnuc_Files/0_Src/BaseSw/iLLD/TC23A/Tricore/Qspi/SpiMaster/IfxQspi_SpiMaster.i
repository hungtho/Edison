...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
# 49 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
...
# 60 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Irq/IfxCpu_Irq.h"
# 1 "0_Src/AppSw/CpuGeneric/Config/Ifx_Cfg.h" 1
# 61 "0_Src/BaseSw/iLLD/TC23A/Tricore/Cpu/Irq/IfxCpu_Irq.h" 2
...
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c" 2
# 62 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
static IfxQspi_SpiMaster_Channel *IfxQspi_SpiMaster_activeChannel(IfxQspi_SpiMaster *handle);
# 77 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
...
SpiIf_Status IfxQspi_SpiMaster_initChannel(IfxQspi_SpiMaster_Channel *chHandle, const IfxQspi_SpiMaster_ChannelConfig *chConfig)
{
    ...
    chHandle->base.flags.onTransfer = (0u);
...

    {
...

        {
            ...
            Ifx__ldmst(&qspiSFR->SSOC.U, (mask | (mask << 16)), (aol | oen));
        }
    }
...
void IfxQspi_SpiMaster_initModule(IfxQspi_SpiMaster *handle, const IfxQspi_SpiMaster_Config *config)
{
...

    {
        ...
        IfxQspi_setSleepMode(qspiSFR, (config->allowSleepMode != (0u)) ? IfxQspi_SleepMode_enable : IfxQspi_SleepMode_disable);
...

    {
        ...
        globalcon.B.AREN = (config->pauseOnBaudrateSpikeErrors != (0u)) ? 1U : 0U;
...

    {
        Ifx_QSPI_GLOBALCON1 globalcon1;
        globalcon1.U = 0;
        globalcon1.B.ERRORENS = (config->base.erPriority > 0) ? ((uint32)0x1FF) : 0;
    ...
    if (config->dma.useDma)
    {
...

        {
            ...
            dmaCfg.hardwareRequestEnabled = (0u);
            dmaCfg.channelInterruptEnabled = (1u);


            dmaCfg.sourceAddress = 0;
            dmaCfg.sourceAddressCircularRange = IfxDma_ChannelIncrementCircular_none;
            dmaCfg.sourceCircularBufferEnabled = (0u);
            ...
            dmaCfg.destinationCircularBufferEnabled = (1u);
...

        {
            ...
            dmaCfg.sourceAddressCircularRange = IfxDma_ChannelIncrementCircular_none;
            dmaCfg.sourceCircularBufferEnabled = (1u);


            dmaCfg.destinationAddress = 0;
            dmaCfg.destinationAddressCircularRange = IfxDma_ChannelIncrementCircular_none;
            dmaCfg.destinationCircularBufferEnabled = (0u);
            dmaCfg.transferCount = 0;
...
void IfxQspi_SpiMaster_initModuleConfig(IfxQspi_SpiMaster_Config *config, Ifx_QSPI *qspi)
{
    ...
    config->qspi = qspi;
    config->allowSleepMode = (0u);
    config->pauseOnBaudrateSpikeErrors = (0u),
...
static SpiIf_Status IfxQspi_SpiMaster_lock(IfxQspi_SpiMaster *handle)
{
    sint32 sending = Ifx__swap((void *)&handle->base.sending, 1UL);
...
static void IfxQspi_SpiMaster_read(IfxQspi_SpiMaster_Channel *chHandle)
{
    ...
    count = Ifx__min(job->remaining, count);
...
static void IfxQspi_SpiMaster_write(IfxQspi_SpiMaster_Channel *chHandle)
{
    ...
    if (handle->dma.useDma)
    {
        ...
        if (job->remaining > 1)
        {
            ...
            if (job->data == ((void *)0))
            {
                IfxDma_setChannelSourceAddress(dmaSFR, txDmaChannelId, (void *)((((((unsigned)(&(chHandle->dummyTxValue)) & 0xF0000000) == 0xD0000000) ? ((((unsigned)(&(chHandle->dummyTxValue)) & 0x000fffff) | 0x70000000) - ((IfxCpu_getCoreId()) * 0x10000000)) : (unsigned)(&(chHandle->dummyTxValue))))));
                ...
                dmaSFR->CH[txDmaChannelId].ADICR.B.SCBE = (1u);
            }
            else
            {
                ...
                dmaSFR->CH[txDmaChannelId].ADICR.B.SCBE = (0u);
            }
        ...
        {
            IfxDma_setChannelDestinationAddress(dmaSFR, rxDmaChannelId, (void *)((((((unsigned)(&(chHandle->dummyRxValue)) & 0xF0000000) == 0xD0000000) ? ((((unsigned)(&(chHandle->dummyRxValue)) & 0x000fffff) | 0x70000000) - ((IfxCpu_getCoreId()) * 0x10000000)) : (unsigned)(&(chHandle->dummyRxValue))))));
            IfxDma_setChannelDestinationIncrementStep(dmaSFR, rxDmaChannelId, IfxDma_ChannelIncrementStep_1,
                IfxDma_ChannelIncrementDirection_positive, IfxDma_ChannelIncrementCircular_4);


            dmaSFR->CH[rxDmaChannelId].ADICR.B.DCBE = (1u);
        }
        else
        {
            ...
            dmaSFR->CH[rxDmaChannelId].ADICR.B.DCBE = (0u);
        }
    ...
    else
    {
        if (job->remaining > 0)
        {
            ...
            Ifx_SizeT count = (Ifx_SizeT)((4) - IfxQspi_getTransmitFifoLevel(qspiSFR));

            if (chHandle->firstWrite == (1u))
            {
            ...
            if (count > 0)
            {
                ...
                boolean lastWrite = (job->remaining == 0) ? (1u) : (0u);
                boolean interruptState;
# 1103 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
                if ((chHandle->firstWrite == (1u)) && (count > 1) && (job->remaining != 0))
                {
