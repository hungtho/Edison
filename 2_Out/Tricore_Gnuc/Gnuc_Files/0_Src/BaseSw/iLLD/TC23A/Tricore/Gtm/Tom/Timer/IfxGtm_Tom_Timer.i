...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tom/Timer/IfxGtm_Tom_Timer.c"
# 49 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tom/Timer/IfxGtm_Tom_Timer.c"
...
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tom/Timer/IfxGtm_Tom_Timer.c" 2
...
# 51 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tom/Timer/IfxGtm_Tom_Timer.c" 2

# 1 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\lib\\gcc\\tricore\\4.9.4\\include\\stddef.h" 1 3 4
# 53 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tom/Timer/IfxGtm_Tom_Timer.c" 2
...
# 54 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tom/Timer/IfxGtm_Tom_Timer.c" 2
...
boolean IfxGtm_Tom_Timer_init(IfxGtm_Tom_Timer *driver, const IfxGtm_Tom_Timer_Config *config)
{
    ...
    if (base->triggerEnabled)
    {
        ...
        if (triggerChannel != driver->timerChannel)
        {
            ...
            IfxGtm_Tom_Tgc_enableChannels(driver->tgc[0], triggerChannelMask, 0, (0u));
        ...
        IfxGtm_Tom_Tgc_enableChannelsOutput(driver->tgc[0], triggerChannelMask, 0, (0u));

        if ((config->base.trigger.outputEnabled) && (config->initPins == (1u)))
        {
...

    {
        ...
        else
        {
            ...
            if (timerHasIrq)
            {
                IfxGtm_Tom_Ch_setNotification(driver->tom, driver->timerChannel, irqMode, (1u), (0u));
                src = IfxGtm_Tom_Ch_getSrcPointer(driver->gtm, config->tom, driver->timerChannel);
            ...
            if (triggerHasIrq)
            {
                IfxGtm_Tom_Ch_setNotification(driver->tom, driver->triggerChannel, irqMode, (0u), (1u));
...
{
    IfxGtm_Tom_Tgc_enableChannels(driver->tgc[0], driver->channelsMask[0], 0, (1u));

    if (driver->tgc[1])
    {
        IfxGtm_Tom_Tgc_enableChannels(driver->tgc[1], driver->channelsMask[1], 0, (1u));
    }
}
...
{
    IfxGtm_Tom_Tgc_enableChannels(driver->tgc[0], 0, driver->channelsMask[0], (1u));

    if (driver->tgc[1])
    {
        IfxGtm_Tom_Tgc_enableChannels(driver->tgc[1], 0, driver->channelsMask[1], (1u));
    }
}
