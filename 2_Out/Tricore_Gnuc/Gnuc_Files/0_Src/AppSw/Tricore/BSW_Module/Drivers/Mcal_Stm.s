...
.Ltext0:
.section .text.Mcal_StmInit,"ax",@progbits
	.align 1
	.global	Mcal_StmInit
	.type	Mcal_StmInit, @function
Mcal_StmInit:
.LFB360:
	.file 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Stm.c"
	.loc 1 81 0
	.loc 1 82 0
	call	initTime
.LVL0:
...
.LVL2:
.LFE360:
	.size	Mcal_StmInit, .-Mcal_StmInit
	.global	stg_STMConf
.section .bss.stg_STMConf,"aw",@nobits
	.align 2
	.type	stg_STMConf, @object
	.size	stg_STMConf, 12
stg_STMConf:
	.zero	12
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Stm.c"
