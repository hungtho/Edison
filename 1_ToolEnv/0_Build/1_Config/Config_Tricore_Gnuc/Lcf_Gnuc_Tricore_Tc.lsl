...
MEMORY
{
	...
	boot (rx!p): org = 0x80000020, len = 6
	boot_nc (rx!p): org = 0xa0000020, len = 6
	pfls0 (rx!p): org = 0x80100000, len = 1M
	pfls0_nc (rx!p): org = 0xa0100000, len = 1M
