...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/Std/IfxQspi.c"
# 49 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/Std/IfxQspi.c"
...
# 61 "0_Src/BaseSw/iLLD/TC23A/Tricore/_Impl/IfxQspi_cfg.h"
...
# 62 "0_Src/BaseSw/iLLD/TC23A/Tricore/_Impl/IfxQspi_cfg.h" 2
...
# 65 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/Std/IfxQspi.h" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/If/SpiIf.h" 1
# 54 "0_Src/BaseSw/Service/CpuGeneric/If/SpiIf.h"
...
# 55 "0_Src/BaseSw/Service/CpuGeneric/If/SpiIf.h" 2
...
# 67 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/Std/IfxQspi.h" 2
...
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/Std/IfxQspi.c" 2
...
uint32 IfxQspi_calculateExtendedConfigurationValue(Ifx_QSPI *qspi, const uint8 cs, const SpiIf_ChConfig *chConfig)
{
    ...
    for (abc = abcMax; abc >= abcMin; abc--)
    {
        ...
        if (( !((error) > (bestError)) ))
        {
            ...
            if (( ((error) > (bestError)) || ((error) < (bestError)) ) || (((uint32)bestAbc & (uint32)0x1) == 0))
            {
                bestError = error;
                bestAbc = abc;
                bestQ = q;
            ...
            {
                done = (( ((error) > (0.0)) || ((error) < (0.0)) )) ? (0u) : (1u);
...
# 194 "0_Src/BaseSw/iLLD/TC23A/Tricore/Qspi/Std/IfxQspi.c"
    halfBaud = bestAbc / 2;
    diffB = halfBaud - maxB;
...
uint32 IfxQspi_calculateTimeQuantumLength(Ifx_QSPI *qspi, float maxBaudrate)
{
    ...
    bestTq = Ifx__max((uint32)((((realTQ) - (sint32)(realTQ)) > 0.5) ? (1 + (sint32)(realTQ)) : ((sint32)(realTQ))), 1);
    ...
    for (index = 0; index < 3; index++)
    {
        ...
        for (preTemp = 0; preTemp < 8; preTemp++)
        {
            ...
            if (delayTemp <= 8)
            {
                ...
                {
                    delayFinal = Ifx__max(delayTemp - 1, 0);
                    preFinal = preTemp;
                    matchFound = (1u);
                    break;
                }
