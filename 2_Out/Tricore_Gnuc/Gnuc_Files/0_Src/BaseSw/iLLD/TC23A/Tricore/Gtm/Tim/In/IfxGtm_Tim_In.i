...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.c"
# 49 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.c"
...
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.c" 2
...
# 52 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.c" 2
...
boolean IfxGtm_Tim_In_init(IfxGtm_Tim_In *driver, const IfxGtm_Tim_In_Config *config)
{
    ...
    driver->dataCoherent = (0u);
    driver->newData = (0u);
    driver->dataLost = (0u);
    driver->overflowCnt = (0u);
        ...
        || (config->filter.risingEdgeMode != IfxGtm_Tim_In_ConfigFilterMode_none))
    {
        ...
        else if (fallingfilterTime > (sint32)(0xffffffu))
        {
        ...
        else if (risingfilterTime > (sint32)(0xffffffu))
        {
...
void IfxGtm_Tim_In_initConfig(IfxGtm_Tim_In_Config *config, Ifx_GTM *gtm)
{
    ...
    config->capture.irqOnNewVal = (0u);
    config->capture.irqOnCntOverflow = (0u);
    config->capture.irqOnEcntOverflow = (0u);
    config->capture.irqOnDatalost = (0u);
    config->capture.clock = IfxGtm_Cmu_Clk_0;
    config->capture.mode = Ifx_Pwm_Mode_leftAligned;
    config->timeout.irqOnTimeout = (0u);
