# 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Multican.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Multican.c"
# 35 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Multican.c"
...
# 36 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Multican.c" 2
# 61 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Multican.c"
volatile dword u32g_Can_DiagRxId = 0U;
volatile dword u32g_Can_DiagRxData[ 2 ] = { 0U, 0U };
st_Multican stg_MulticanBasic;
# 84 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Multican.c"
void Mcal_MulticanInit( void )
{
 ...
 IfxMultican_Can_initModuleConfig ( &canConfig, ( ( Ifx_CAN *)( void *)&(*(Ifx_CAN *)0xF0018000u) ) );

 canConfig.nodePointer[ IfxMultican_SrcId_0 ].priority = ( 15 );
 canConfig.nodePointer[ IfxMultican_SrcId_0 ].typeOfService = IfxSrc_Tos_cpu0;

 canConfig.nodePointer[ IfxMultican_SrcId_1 ].priority = ( 14 );
 canConfig.nodePointer[ IfxMultican_SrcId_1 ].typeOfService = IfxSrc_Tos_cpu0;

 canConfig.nodePointer[ IfxMultican_SrcId_2 ].priority = ( 13 );
 ...
 if( IfxMultican_Can_initModule ( &stg_MulticanBasic.can, &canConfig) == IfxMultican_Status_ok )
 {
  ...
  canNodeConfig.alertInterrupt.enabled = (1u);
  canNodeConfig.alertInterrupt.srcId = IfxMultican_SrcId_1;
  canNodeConfig.transferInterrupt.enabled = (1u);
...
# 135 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Multican.c"
void Mcal_MulticanObjCfg ( void )
{
 ...
 canMsgObjConfig.messageId = ( 0x18FF4027U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_receive;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);

 canMsgObjConfig.rxInterrupt.enabled = (1u);
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x18FF1067U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_receive;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x0CF80167U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_receive;
 ...
 IfxMultican_Can_MsgObj_initConfig ( &canMsgObjConfig, &stg_MulticanBasic.canSrcNode );
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x18FF1167U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_receive;
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x0CF80968U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_receive;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x18DA1AF9U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_receive;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x18DBFFF9U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_receive;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x18FF3071U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_transmit;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);
 canMsgObjConfig.txInterrupt.enabled = (1u);
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x18FF3171U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_transmit;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x18FF3170U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_transmit;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x18FF3070U );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_transmit;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);
 ...
 canMsgObjConfig.msgObjId = canMsgObjId;
 canMsgObjConfig.messageId = ( 0x18DAF91AU );
 canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.frame = IfxMultican_Frame_transmit;
 canMsgObjConfig.control.extendedFrame = (1u);
 canMsgObjConfig.control.matchingId = (1u);
...
# 337 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Multican.c"
