# 1 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
# 35 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
...
# 1 "0_Src/AppSw/Tricore/RTE_Module/Rte_Typedef.h" 1
# 39 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.h" 2
...
# 36 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c" 2
...
# 37 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c" 2
# 55 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
...
# 75 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
...
# 94 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
void Asw_Ldc_AdcInit ( void )
{
 st_VinLimit.f32_limit [ NOR_LOWER ] = ( 280.0f );
 st_VinLimit.f32_limit [ NOR_UPPER ] = ( 420.0f );
 st_VinLimit.f32_limit [ NOR_RECOVER_LOWER ] = ( 290.0f );
 st_VinLimit.f32_limit [ NOR_RECOVER_UPPER ] = ( 415.0f );

 st_IinLimit.f32_limit [ NOR_LOWER ] = ( 0.0f );
 st_IinLimit.f32_limit [ NOR_UPPER ] = ( 13.0f );
 st_IinLimit.f32_limit [ NOR_RECOVER_LOWER ] = ( 0.0f );
 st_IinLimit.f32_limit [ NOR_RECOVER_UPPER ] = ( 1.0f );

 st_VoutLimit.f32_limit [ NOR_LOWER ] = ( 9.0f );
 st_VoutLimit.f32_limit [ NOR_UPPER ] = ( 16.0f );
 st_VoutLimit.f32_limit [ NOR_RECOVER_LOWER ] = ( 10.0f );
 st_VoutLimit.f32_limit [ NOR_RECOVER_UPPER ] = ( 15.0f );

 st_IoutLimit.f32_limit [ NOR_LOWER ] = ( 0.0f );
 st_IoutLimit.f32_limit [ NOR_UPPER ] = ( 220.0f );
 st_IoutLimit.f32_limit [ NOR_RECOVER_LOWER ] = ( 0.0f );
 st_IoutLimit.f32_limit [ NOR_RECOVER_UPPER ] = ( 1.0f );

 st_TempLimit.f32_limit [ NOR_LOWER ] = ( 10.0f );
 st_TempLimit.f32_limit [ NOR_UPPER ] = ( 125.0f );
 st_TempLimit.f32_limit [ NOR_RECOVER_LOWER ] = ( 15.0f );
 st_TempLimit.f32_limit [ NOR_RECOVER_UPPER ] = ( 120.0f );
 st_TempLimit.f32_limit [ FAULT_UPPER ] = ( 155.0f );

 st_BattVoltLimit.f32_limit[ NOR_LOWER ] = ( 9.0f );
 st_BattVoltLimit.f32_limit[ NOR_UPPER ] = ( 17.5f );
 st_BattVoltLimit.f32_limit[ NOR_RECOVER_LOWER ] = ( 10.0f );
 st_BattVoltLimit.f32_limit[ NOR_RECOVER_UPPER ] = ( 16.5f );
}
# 135 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
...
# 161 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
en_STATE_DEF Asw_Adc_NormalMode( st_AdcLimitValue *stp_Limit, single f32_adcRealValue )
{
 ...
 if( f32_adcRealValue < stp_Limit->f32_limit[ NOR_LOWER ] )
 {
  ...
  if( stp_Limit->u16_FaultUnderCnt < ( 500U ) )
  {
 ...
 else
 {
  ...
  if( stp_Limit->u16_FaultOvertCnt < ( 500U ) )
  {
...
# 210 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
...
# 250 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
...
# 290 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
en_STATE_DEF Asw_Adc_TempNormalMode ( st_AdcLimitValue *stp_Limit, single f32_adcRealTemp )
{
 ...
 else
 {
  stp_Limit->u16_FaultUnderCnt = 0U;
  stp_Limit->u16_FaultOvertCnt = 0U;
  if( stp_Limit->u16_DeratingCnt < ( 500U ) )
  {
...
# 352 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
...
# 407 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
static en_STATE_DEF DiagAdc_LdcInputV ( en_STATE_DEF u8_HV_V, st_AdcLimitValue *stp_AdcLimit, single f32_adcRealInputV )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
...
# 441 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
static en_STATE_DEF DiagAdc_LdcInputI ( en_STATE_DEF u8_HV_I, st_AdcLimitValue *stp_AdcLimit, single f32_adcRealinputI )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
# 460 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
 u8_rtn = STATE_NORMAL;

 return u8_rtn;
}
# 472 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
static en_STATE_DEF DiagAdc_LdcOutputV ( en_STATE_DEF u8_LV_V, st_AdcLimitValue *stp_AdcLimit, single f32_adcRealOutputV )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
# 494 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
 u8_rtn = STATE_NORMAL;

 return u8_rtn;
}
# 506 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
static en_STATE_DEF DiagAdc_LdcOutputI ( en_STATE_DEF u8_LV_I, st_AdcLimitValue *stp_AdcLimit, single f32_adcRealOutputI )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
...
# 552 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
static en_STATE_DEF DiagAdc_LdcTemp ( en_STATE_DEF u8_Temp, st_AdcLimitValue *stp_AdcLimit, single f32_adcRealTemp )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
# 568 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
 u8_rtn = STATE_NORMAL;

 return u8_rtn;
}
# 580 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
static en_STATE_DEF DiagAdc_Ldc14VBat ( en_STATE_DEF u8_14VBat, st_AdcLimitValue *stp_AdcLimit, single f32_adcReal14Bat )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
# 602 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
 u8_rtn = STATE_NORMAL;

 return u8_rtn;
}
# 614 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
static en_STATE_DEF DiagAdc_OutputI_Over ( en_STATE_DEF u8_LV_I_over, byte u8_overcurrent_state )
{
 en_STATE_DEF u8_rtn = STATE_NORMAL;
# 655 "0_Src/AppSw/Tricore/ASW_Module/LDC/ASW_LdcDiagAdc.c"
 u8_rtn = STATE_NORMAL;
