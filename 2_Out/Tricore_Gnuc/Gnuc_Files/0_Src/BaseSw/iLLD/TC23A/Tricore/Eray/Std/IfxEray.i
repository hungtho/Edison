...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Eray/Std/IfxEray.c"
# 49 "0_Src/BaseSw/iLLD/TC23A/Tricore/Eray/Std/IfxEray.c"
...
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Eray/Std/IfxEray.c" 2
...
void IfxEray_setMessageBufferInterruptDestination(Ifx_ERAY *eray, uint8 messageBuffer, uint8 messageBufferDestination)
{
    ...
    if (messageBufferDestination == (0u))
    {
        msicSFR->U &= ~mask;
    }
    else
...
void IfxEray_setSlot(Ifx_ERAY *eray, const IfxEray_Header *header, const uint32 *data, const IfxEray_SlotConfig *slotConfig)
{
    ...
    while (IfxEray_getInputBufferBusyHostStatus(eray) == (1u))
    {}
    ...
    while (IfxEray_getInputBufferBusyShadowStatus(eray) == (1u))
    {}
