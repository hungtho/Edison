# 1 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
# 35 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
...
# 36 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c" 2
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c" 2

# 1 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_Multican.h" 1
# 36 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_Multican.h"
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_Multican.h" 2
...
# 38 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_Multican.h" 2
...
# 39 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_Multican.h" 2
# 68 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_Multican.h"
typedef struct
{
 IfxMultican_Can can;
...
# 97 "0_Src/AppSw/Tricore/BSW_Module/UDS/../Drivers/Mcal_Multican.h"
...
# 39 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c" 2
# 65 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
...
byte u8g_TpTxBuf[ ( 150U ) ];
byte u8g_TpRxBuf[ ( 150U ) ];
...
# 108 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
void Bsw_TpFunc_Init ( void )
{
 byte u8_Cnt;

 for( u8_Cnt = 0U; u8_Cnt < ( 150U ); u8_Cnt++ )
 {
...
# 150 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
...
# 203 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
byte Bsw_TpRecvProc ( byte *u8p_IsEndFrame, byte *u8p_RecvLen, byte *u8p_ReqType )
{
 ...
 byte u8_STmin;
  ...
  u8_CANFrameData[ 0 ] = ( ( byte )( u32g_Can_DiagRxData[ 0 ] ) );
  u8_CANFrameData[ 1 ] = ( ( byte )( ( ( dword )( u32g_Can_DiagRxData[ 0 ] ) ) >> 8 ) );
  u8_CANFrameData[ 2 ] = ( ( byte )( ( ( dword )( u32g_Can_DiagRxData[ 0 ] ) ) >> 16 ) );
  u8_CANFrameData[ 3 ] = ( ( byte )( ( ( dword )( u32g_Can_DiagRxData[ 0 ] ) ) >> 24 ) );
  u8_CANFrameData[ 4 ] = ( ( byte )( u32g_Can_DiagRxData[ 1 ] ) );
  u8_CANFrameData[ 5 ] = ( ( byte )( ( ( dword )( u32g_Can_DiagRxData[ 1 ] ) ) >> 8 ) );
  u8_CANFrameData[ 6 ] = ( ( byte )( ( ( dword )( u32g_Can_DiagRxData[ 1 ] ) ) >> 16 ) );
  u8_CANFrameData[ 7 ] = ( ( byte )( ( ( dword )( u32g_Can_DiagRxData[ 1 ] ) ) >> 24 ) );
 ...
 {
  u8_FrameType = ( ( byte )( ( ( ( u8_CANFrameData[ 0 ] ) ) & 0xF0U ) >> 4 ) );
  u8_Dlc = ( ( byte )( ( ( ( u8_CANFrameData[ 0 ] ) ) & 0x0FU ) ) );
  ...
  switch( u8_FrameType )
  {
   ...
   case ( 3U ):
    ...
    if( u8_STmin < ( 1U ) ){ u16s_STminTickCnt = ( word )( ( 1U ) / ( 1U ) ); }
    else if( u8_STmin > ( 127U ) ){ u16s_STminTickCnt = ( word )( ( 127U ) / ( 1U ) ); }
    else{ u16s_STminTickCnt = ( word )( u8_STmin / ( 1U ) ); }
...
# 343 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
void Bsw_TpSingleFrame ( byte u8_DataLen )
{
 byte u8_TpIdx;
 byte u8_TpFrame[ 8 ];

 u8_TpFrame[ 0 ] = ( byte )( ( 0U ) << 4U );
...
# 370 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
void Bsw_TpFirstFrame ( byte u8_DataLen )
{
 byte u8_TpIdx;
 byte u8_TpFrame[ 8 ];

 u8_TpFrame[ 0 ] = ( byte )( ( 1U ) << 4U );
...
# 405 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
static void TpFlowControlFrame ( void )
{
 byte u8_TpFrame[ 8 ];


 u8_TpFrame[ 0 ] = ( byte )( ( 3U ) << 4U );
 u8_TpFrame[ 1 ] = ( 8U );
 u8_TpFrame[ 2 ] = ( 20U );
...
# 426 "0_Src/AppSw/Tricore/BSW_Module/UDS/BSW_TpFunc.c"
static void TpSendFrame ( const byte *p_Data, byte u8_Size )
{
 ...
 st_CAN_Tx_PhysResponse.data[ 0 ] = ( ( dword )( ( ( ( dword )( u8_FrameData[ 3 ] ) ) << 24 ) | ( ( ( dword )( u8_FrameData[ 2 ] ) ) << 16 ) | ( ( ( dword )( u8_FrameData[ 1 ] ) ) << 8 ) | ( ( dword )( u8_FrameData[ 0 ] ) ) ) );
 st_CAN_Tx_PhysResponse.data[ 1 ] = ( ( dword )( ( ( ( dword )( u8_FrameData[ 7 ] ) ) << 24 ) | ( ( ( dword )( u8_FrameData[ 6 ] ) ) << 16 ) | ( ( ( dword )( u8_FrameData[ 5 ] ) ) << 8 ) | ( ( dword )( u8_FrameData[ 4 ] ) ) ) );

 Mcal_CanTransmit ( ( 0x18DAF91AU ), &st_CAN_Tx_PhysResponse, &stg_MulticanBasic.can0TxMsgObj_PHYS_RESPONSE );
}
