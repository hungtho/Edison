...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC23A/Tricore/Eth/Std/IfxEth.c"
# 49 "0_Src/BaseSw/iLLD/TC23A/Tricore/Eth/Std/IfxEth.c"
...
# 50 "0_Src/BaseSw/iLLD/TC23A/Tricore/Eth/Std/IfxEth.c" 2
...
void IfxEth_setupMiiInputPins(IfxEth *eth, const IfxEth_MiiPins *miiPins)
{
    ...
    else
    {
        ...
        (*(volatile Ifx_ETH_GPCTL *)0xF001D008u).B.ALTI2 = Ifx_RxSel_d;
    }

    if (miiPins->col != ((void *)0))
    {
    ...
    else
    {
        ...
        (*(volatile Ifx_ETH_GPCTL *)0xF001D008u).B.ALTI3 = Ifx_RxSel_d;
    }
    ...
    else
    {
        ...
        (*(volatile Ifx_ETH_GPCTL *)0xF001D008u).B.ALTI5 = Ifx_RxSel_d;
    }
    ...
    (*(volatile Ifx_ETH_GPCTL *)0xF001D008u).B.ALTI0 = mdio->inSelect;
}
