# 1 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
# 35 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
...
# 36 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c" 2
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c" 2
...
# 38 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c" 2

# 1 "0_Src/AppSw/Tricore/BSW_Module/Services/../Drivers/Mcal_Stm.h" 1
# 36 "0_Src/AppSw/Tricore/BSW_Module/Services/../Drivers/Mcal_Stm.h"
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/Services/../Drivers/Mcal_Stm.h" 2
# 65 "0_Src/AppSw/Tricore/BSW_Module/Services/../Drivers/Mcal_Stm.h"
...
# 40 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c" 2
# 58 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""isr_StmTimer_handler"",""0"",""( 30 )" );extern void __attribute__ ((interrupt_handler)) isr_StmTimer_handler(); void isr_StmTimer_handler (void);

__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""isr_VADC0_handler"",""0"",""( 20 )" );extern void __attribute__ ((interrupt_handler)) isr_VADC0_handler(); void isr_VADC0_handler (void);
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""isr_VADC1_handler"",""0"",""( 19 )" );extern void __attribute__ ((interrupt_handler)) isr_VADC1_handler(); void isr_VADC1_handler (void);

__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""isr_CanTx_Handler"",""0"",""( 14 )" );extern void __attribute__ ((interrupt_handler)) isr_CanTx_Handler(); void isr_CanTx_Handler (void);
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""isr_CanRx_Handler"",""0"",""( 15 )" );extern void __attribute__ ((interrupt_handler)) isr_CanRx_Handler(); void isr_CanRx_Handler (void);
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""isr_CanBusOff_Handler"",""0"",""( 13 )" );extern void __attribute__ ((interrupt_handler)) isr_CanBusOff_Handler(); void isr_CanBusOff_Handler (void);
...
# 98 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
void isr_StmTimer_handler ( void )
{
  IfxStm_increaseCompare ( ( ( Ifx_STM *)( void *)&(*(Ifx_STM *)0xF0000000u) ), stg_STMConf.comparator, (TimeConst[(4)]) );
  u8g_task_flag_100u = 1U;

  _enable();
}
# 113 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
...
# 137 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
void isr_VADC0_handler ( void )
{
 static word u16s_Index_Ldc[ ( 7U ) ];

 Mcal_AdcBuffer ( st_Vadc0Ldc, 0U, u16g_hisLdcIout, u16s_Index_Ldc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc0Ldc, 1U, u16g_hisLdcVout, u16s_Index_Ldc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc0Ldc, 2U, u16g_hisLdcIin, u16s_Index_Ldc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc0Ldc, 3U, u16g_hisLdcVin, u16s_Index_Ldc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc0Ldc, 4U, u16g_hisObcBattSens, u16s_Index_Ldc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc0Ldc, 5U, u16g_hisLdcBattSens, u16s_Index_Ldc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc0Ldc, 6U, u16g_hisLdcTemp, u16s_Index_Ldc, ( 10U ) );

 _enable();
}
# 159 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
void isr_VADC1_handler ( void )
{
 static word u16s_Index_Obc[( 7U ) ];

 Mcal_AdcBuffer ( st_Vadc1Obc, 0U, u16g_hisObcIout, u16s_Index_Obc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc1Obc, 1U, u16g_hisObcVout, u16s_Index_Obc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc1Obc, 2U, u16g_hisObcIin, u16s_Index_Obc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc1Obc, 3U, u16g_hisObcVin, u16s_Index_Obc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc1Obc, 4U, u16g_hisObcJ1772Vol, u16s_Index_Obc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc1Obc, 5U, u16g_hisObcBplusSense, u16s_Index_Obc, ( 10U ) );
 Mcal_AdcBuffer ( st_Vadc1Obc, 7U, u16g_hisObcTemp, u16s_Index_Obc, ( 10U ) );
 _enable();
}
# 180 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
...
void isr_CanRx_Handler ( void )
{
 ...
 if (IfxMultican_Can_MsgObj_isRxPending ( &stg_MulticanBasic.can0RxMsgObj_FUNC_REQUEST ) == 1U )
 {
  ...
  u8g_Can_DiagRxFlag = STATE_NORMAL;
  u32g_Can_DiagRxId = ( 0x18DBFFF9U );
 }

 _enable();
}
# 284 "0_Src/AppSw/Tricore/BSW_Module/Services/BSW_ISR.c"
