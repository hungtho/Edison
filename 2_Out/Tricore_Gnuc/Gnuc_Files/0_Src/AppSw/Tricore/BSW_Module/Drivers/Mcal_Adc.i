# 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c"
# 35 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_Adc.h" 1
# 36 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_Adc.h"
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_Adc.h" 2
...
# 38 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_Adc.h" 2
...
# 39 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_Adc.h" 2
# 56 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_Adc.h"
typedef struct
{
 IfxVadc_Adc vadc;
...
# 71 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_Adc.h"
...
# 36 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c" 2
# 55 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c"
...
word u16g_hisLdcVout[ ( 10U ) ];
word u16g_hisLdcIout[ ( 10U ) ];
word u16g_hisLdcIin[ ( 10U ) ];
word u16g_hisLdcVin[ ( 10U ) ];
word u16g_hisLdcTemp[ ( 10U ) ];
word u16g_hisLdcBattSens[ ( 10U ) ];
word u16g_hisObcBattSens[ ( 10U ) ];


word u16g_hisObcVout[ ( 10U ) ];
word u16g_hisObcIout[ ( 10U ) ];
word u16g_hisObcVin[ ( 10U ) ];
word u16g_hisObcIin[ ( 10U ) ];
word u16g_hisObcTemp[ ( 10U ) ];
word u16g_hisObcJ1772Vol[ ( 10U ) ];
word u16g_hisObcBplusSense[ ( 10U ) ];
# 86 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c"
st_VadcScan st_Vadc0Ldc;
st_VadcScan st_Vadc1Obc;
# 101 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c"
void Mcal_Ldc_VadcInit ( void )
{
  ...
  IfxVadc_Adc_initModuleConfig ( &adcConf, ( ( Ifx_VADC *)( void *)&(*(Ifx_VADC *)0xF0020000u) ) );
  if( IfxVadc_Adc_initModule ( &st_Vadc0Ldc.vadc, &adcConf ) == IfxVadc_Status_noError ){};


  IfxVadc_Adc_initGroupConfig ( &adcGroupConf, &st_Vadc0Ldc.vadc );


  adcGroupConf.groupId = IfxVadc_GroupId_0;
  adcGroupConf.master = adcGroupConf.groupId;

  adcGroupConf.arbiter.requestSlotScanEnabled = (1u);
  adcGroupConf.scanRequest.autoscanEnabled = (0u);


  adcGroupConf.scanRequest.triggerConfig.gatingMode = IfxVadc_GatingMode_always;

  if( IfxVadc_Adc_initGroup ( &st_Vadc0Ldc.adcGroup, &adcGroupConf ) == IfxVadc_Status_noError ){};


  dword chnIx;


  IfxVadc_Adc_ChannelConfig adcChannelConf [ ( 7U ) ];
  const IfxVadc_ChannelId adcLdcChannelNum[ ( 7U ) ] = { IfxVadc_ChannelId_0,
                              IfxVadc_ChannelId_1 ,
                             IfxVadc_ChannelId_2,
                             IfxVadc_ChannelId_3,
                             IfxVadc_ChannelId_4,
  ...
  for( chnIx = 0U; chnIx < ( 7U ); ++chnIx )
  {
  IfxVadc_Adc_initChannelConfig ( &adcChannelConf[ chnIx ], &st_Vadc0Ldc.adcGroup );

  adcChannelConf [ chnIx ].channelId = ( IfxVadc_ChannelId ) adcLdcChannelNum[ chnIx ];
  adcChannelConf [ chnIx ].resultRegister = ( IfxVadc_ChannelResult )adcLdcChannelNum[ chnIx ];
  adcChannelConf [ ( 7U )-1U ].resultPriority = ( 20 );
  adcChannelConf [ ( 7U )-1U ].resultServProvider = IfxSrc_Tos_cpu0;


  if( IfxVadc_Adc_initChannel ( &st_Vadc0Ldc.adcChannel[chnIx], &adcChannelConf[chnIx] ) == IfxVadc_Status_noError ){};


  dword enableChnBit = ( 1 << adcChannelConf [ chnIx ].channelId );
  dword mask = enableChnBit;
  IfxVadc_Adc_setScan ( &st_Vadc0Ldc.adcGroup, enableChnBit, mask );
  }


  IfxVadc_Adc_startScan ( &st_Vadc0Ldc.adcGroup );
}
# 167 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c"
void Mcal_Obc_VadcInit ( void )
{
  ...
  IfxVadc_Adc_initModuleConfig ( &adcConf, ( ( Ifx_VADC *)( void *)&(*(Ifx_VADC *)0xF0020000u) ) );
  if( IfxVadc_Adc_initModule ( &st_Vadc1Obc.vadc, &adcConf ) == IfxVadc_Status_noError ){};


  IfxVadc_Adc_initGroupConfig ( &adcGroupConf, &st_Vadc1Obc.vadc );


  adcGroupConf.groupId = IfxVadc_GroupId_1;
  adcGroupConf.master = adcGroupConf.groupId;
  ...
  if( IfxVadc_Adc_initGroup ( &st_Vadc1Obc.adcGroup, &adcGroupConf ) == IfxVadc_Status_noError ){};
  ...
  for( chnIx = 0; chnIx < ( 7U ); ++chnIx )
  {
      IfxVadc_Adc_initChannelConfig ( &adcChannelConf[ chnIx ], &st_Vadc1Obc.adcGroup );

      adcChannelConf [ chnIx ].channelId = ( IfxVadc_ChannelId ) adcLdcChannelNum[ chnIx ];
      adcChannelConf [ chnIx ].resultRegister = ( IfxVadc_ChannelResult )adcLdcChannelNum[ chnIx ];
      adcChannelConf [ ( 7U )-1U ].resultPriority = ( 19 );
      adcChannelConf [ ( 7U )-1U ].resultServProvider = IfxSrc_Tos_cpu0;
      ...
      dword enableChnBit = ( 1 << adcChannelConf [ chnIx ].channelId );
      dword mask = enableChnBit;
      IfxVadc_Adc_setScan ( &st_Vadc1Obc.adcGroup, enableChnBit, mask );
  }


  IfxVadc_Adc_startScan ( &st_Vadc1Obc.adcGroup );
}
# 233 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c"
void Mcal_AdcBuffer ( st_VadcScan st_adcScan, byte u8_chn, word u16_buffer[], word u16_Index[], byte u8_size)
{
 if( u8_chn < ( 7U ) )
 {
  u16_buffer[ u16_Index[ u8_chn ] ] = CpuInADC ( st_adcScan, u8_chn );

  u16_Index[ u8_chn ]++;
  if( u16_Index[ u8_chn ] >= u8_size ){ u16_Index[ u8_chn ] = 0U; }
 }
}
# 263 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_Adc.c"
static word CpuInADC ( st_VadcScan st_adcScan, byte u8_AdcCh )
{

 volatile Ifx_VADC_G_RES converResult;
