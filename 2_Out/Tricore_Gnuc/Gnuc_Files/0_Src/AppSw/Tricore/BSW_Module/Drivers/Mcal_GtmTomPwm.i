# 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
# 1 "D:\\07_Working\\Edison\\Edison//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
# 35 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_GtmTomPwm.h" 1
# 36 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_GtmTomPwm.h"
# 1 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/../Drivers/Mcal_GtmTim.h" 1
# 36 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/../Drivers/Mcal_GtmTim.h"
...
# 65 "0_Src/BaseSw/iLLD/TC23A/Tricore/Gtm/Tim/In/IfxGtm_Tim_In.h" 2
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/../Drivers/Mcal_GtmTim.h" 2
...
# 39 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/../Drivers/Mcal_GtmTim.h" 2
# 67 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/../Drivers/Mcal_GtmTim.h"
...
# 37 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_GtmTomPwm.h" 2
...
# 38 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_GtmTomPwm.h" 2
# 57 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_GtmTomPwm.h"
typedef enum
{
 DISABLE = 0U,
 ENABLE
...
# 104 "0_Src/AppSw/Tricore/BSW_Module/Drivers/../Drivers/Mcal_GtmTomPwm.h"
...
# 36 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c" 2
# 56 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
static void GtmTomInit_Ldc ( void );
static void GtmTomInit_Obc ( void );
# 70 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
static sts_GtmTomPwmHl st_GtmPwmHlLdc;
static sts_GtmTomPwmHl st_GtmPwmHlObc;
# 85 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
void Mcal_GtmTomInit ( void )
{


 Ifx_GTM *stp_gtm = ( ( Ifx_GTM *)( void *)&(*(Ifx_GTM *)0xF0100000u) );
 ...
 st_GtmPwmHlLdc.info.gtmCmuClk0Freq = IfxGtm_Cmu_getClkFrequency( stp_gtm, IfxGtm_Cmu_Clk_0, (1u) );
 ...
 st_GtmPwmHlObc.info.gtmCmuClk0Freq = IfxGtm_Cmu_getClkFrequency ( stp_gtm, IfxGtm_Cmu_Clk_0, (1u) );
 st_GtmPwmHlObc.info.state = GtmTomPwmHl_State_init;

 GtmTomInit_Ldc ();
 GtmTomInit_Obc ();

 IfxGtm_Cmu_enableClocks ( stp_gtm, ( dword )(0x00800000) | (dword )(0x00000002) );
}
# 116 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
void Mcal_LDC_PWMAB_updateShift ( dword u32_shift, en_PWM_STATE u8_pwmON )
{
 dword u32_period = ( 1000U );
 dword u32_deadtime = ( 60U );
...
# 156 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
...
# 196 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
void Mcal_OBC_PWMAB_updatefrequency ( single f32_freq, en_PWM_STATE u8_pwmON )
{
 ...
 Ifx_GTM *pgtm = ( ( Ifx_GTM *)( void *)&(*(Ifx_GTM *)0xF0100000u) );
 ...
 if( u8_pwmON == ENABLE )
 {
  ...
  u32_period = ( dword )IfxGtm_Cmu_getClkFrequency ( pgtm, IfxGtm_Cmu_Clk_0, (1u) ) / f32_freq;
 ...
 else
 {
  ...
  IfxGtm_Tom_Timer_disableUpdate ( ptimer );
  IfxGtm_Tom_PwmHl_setOnTime ( pdriver, ((void *)0) );
 }

 IfxGtm_Tom_Timer_applyUpdate ( ptimer );
}
# 242 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
void Mcal_OBC_PWMCD_updatefrequency ( single f32_freq, en_PWM_STATE u8_pwmON )
{
 ...
 if( u8_pwmON == ENABLE )
 {
  if( IfxGtm_Tom_PwmHl_setMode ( pdriver, Ifx_Pwm_Mode_centerAligned ) == (boolean)(1u) ){};
  if( IfxGtm_Tom_Timer_setFrequency ( ptimer, f32_freq ) == ( boolean )1U ){}
  u32_period = ( dword )( IfxGtm_Cmu_getClkFrequency ( pgtm, IfxGtm_Cmu_Clk_0, (1u) ) / f32_freq );
...
# 294 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
static void GtmTomInit_Ldc( void )
{
 IfxGtm_Tom_Timer_Config timerConfig;
 IfxGtm_Tom_PwmHl_Config pwmHlConfig;

  IfxGtm_Tom_Timer_initConfig ( &timerConfig, ( ( Ifx_GTM *)( void *)&(*(Ifx_GTM *)0xF0100000u) ) );

  timerConfig.base.frequency = ( 100000.0F );
  timerConfig.base.minResolution = ( 1.0f / timerConfig.base.frequency ) / 1000.0f;
  timerConfig.base.trigger.enabled = (0u);
  ...
  timerConfig.base.trigger.outputEnabled = (1u);
  timerConfig.base.trigger.enabled = (0u);
  timerConfig.base.trigger.triggerPoint = 500;
  timerConfig.base.trigger.risingEdgeAtPeriod = (1u);
 ...
 ldc_ccx[0] = &IfxGtm_TOM1_7_TOUT64_P20_8_OUT;
 ldc_coutx[0] = &IfxGtm_TOM1_4_TOUT65_P20_9_OUT;
 ldc_ccx[1] = &IfxGtm_TOM1_5_TOUT66_P20_10_OUT;
 ldc_coutx[1] = &IfxGtm_TOM1_3_TOUT71_P15_0_OUT;
 ...
 pwmHlConfig.base.emergencyEnabled = (0u);
...
# 352 "0_Src/AppSw/Tricore/BSW_Module/Drivers/Mcal_GtmTomPwm.c"
static void GtmTomInit_Obc( void )
{
 IfxGtm_Tom_Timer_Config timerConfig;
 IfxGtm_Tom_PwmHl_Config pwmHlConfig;
  ...
  timerConfig.base.frequency = ( 200000.0F );
  timerConfig.base.minResolution = (1.0f / timerConfig.base.frequency) / 1000.0f;
  timerConfig.base.trigger.enabled = (0u);
 ...
 obc_ccx[0] = &IfxGtm_TOM0_12_TOUT98_P11_9_OUT;
 obc_coutx[0] = &IfxGtm_TOM0_13_TOUT99_P11_10_OUT;
 obc_ccx[1] = &IfxGtm_TOM0_15_TOUT101_P11_12_OUT;
 obc_coutx[1] = &IfxGtm_TOM0_14_TOUT100_P11_11_OUT;
